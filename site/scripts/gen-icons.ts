...
async function main() {
  ...
  await sharp(svg)
    .resize(192, 192)
    .png()
    .toFile(resolve(ICONS, "icon-192.png"));
  await sharp(svg)
    .resize(512, 512)
    .png()
    .toFile(resolve(ICONS, "icon-512.png"));
  ...
  await sharp(svg)
    .resize(16, 16)
    .png()
    .toFile(resolve(ICONS, "favicon-16.png"));
  await sharp(svg)
    .resize(32, 32)
    .png()
    .toFile(resolve(ICONS, "favicon-32.png"));
  await sharp(svg)
    .resize(180, 180)
    .png()
    .toFile(resolve(ICONS, "apple-touch-icon-180.png"));
