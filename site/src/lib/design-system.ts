...
export const designSystem = {
  ...
  typography: {
    // Page Titles (H1)
    pageTitle: "text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 glow-text leading-tight",
    
    // Section Titles (H2) 
    sectionTitle: "text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-4 text-white leading-tight",
    
    // Subsection Titles (H3)
    subsectionTitle: "text-lg sm:text-xl md:text-2xl font-semibold mb-3 text-cyan-300 leading-tight",
    
    // Card/Component Titles (H4)
    cardTitle: "text-base sm:text-lg md:text-xl font-semibold mb-2 text-white leading-tight",
  ...
  effects: {
    ...
    glassInteractive: "glass backdrop-blur-md bg-white/5 border border-white/10 hover:border-cyan-500/30 hover:bg-white/8 transition-all duration-300",
  ...
  components: {
    ...
    cardHover: "glass p-6 rounded-lg hover:border-cyan-500/50 hover:bg-white/8 transition-all duration-300",
    
    // Feature list styling
    featureList: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8",
    
    // Hero section
    heroSection: "relative py-16 md:py-20 lg:py-24 px-4 sm:px-6 text-center overflow-hidden",
    
    // Content section
    contentSection: "py-12 md:py-16 lg:py-20 px-4 sm:px-6",
    
    // Two-column layout
    twoColumnGrid: "grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center"
  },
  ...
  buttons: {
    ...
    inlineLink: "text-cyan-300 hover:text-cyan-200 underline underline-offset-4 transition-colors duration-300"
  },
...
export function designClasses(...classes: (string | undefined | null | false)[]): string {
