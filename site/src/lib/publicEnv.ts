...
export const publicEnv = {
  ...
  contactInbox:
    process.env.NEXT_PUBLIC_CONTACT_INBOX || "contact@prowebstudio.nl",

  // Analytics & Integrations
  plausibleDomain:
    process.env.NEXT_PUBLIC_PLAUSIBLE_DOMAIN || "prowebstudio.nl",
  calcomUrl:
    process.env.NEXT_PUBLIC_CALCOM_URL || "https://cal.com/prowebstudio",
  ...
  webVitalsEnabled:
    (process.env.NEXT_PUBLIC_ENABLE_WEB_VITALS ?? "false") === "true",
