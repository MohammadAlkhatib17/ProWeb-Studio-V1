...
export const locationMetadata = {
  amsterdam: {
    ...
    description:
      "Website laten maken Amsterdam - Professionele webdesign in de hoofdstad",
  ...
  rotterdam: {
    ...
    description:
      "Website laten maken Rotterdam - Innovatieve weboplossingen in de Maasstad",
  ...
  "den-haag": {
    ...
    description:
      "Website laten maken Den Haag - Webdesign voor overheid en bedrijfsleven",
  ...
  groningen: {
    ...
    description:
      "Website laten maken Groningen - Noordelijke kwaliteit, landelijke service",
...
export const serviceMetadata = {
  ...
  "webshop-laten-maken": {
    ...
    description:
      "Complete webshop laten ontwikkelen met iDEAL en verzendintegratie",
    keywords: [
      "webshop laten maken",
      "e-commerce",
      "online verkopen",
...
export function generateOpenGraph(
  ...
  return {
    ...
    type: (options.pageType
      ? pageTypeMetadata[options.pageType].type
      : "website") as "website",
...
export function generateMetadata(
  ...
  const otherMeta: Record<string, string> = {
    ...
    ...(options.location &&
      locationMetadata[options.location] && {
