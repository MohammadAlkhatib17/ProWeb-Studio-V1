...
export const DynamicImports = {
  ...
  HeroCanvas: () =>
    import("@/components/HeroCanvas").then((mod) => ({ default: mod.default })),
  ViewportAware3D: () =>
    import("@/components/ViewportAware3D").then((mod) => ({
      default: mod.default,
    })),
  Progressive3DLoader: () =>
    import("@/components/3d/Progressive3DLoader").then((mod) => ({
      default: mod.default,
    })),

  // Contact form - load on interaction
  CalEmbed: () =>
    import("@/components/CalEmbed").then((mod) => ({ default: mod.default })),
...
export class IntelligentLoader {
  ...
  static async loadOnInteraction(
