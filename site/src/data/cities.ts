...
export const cities: CityData[] = [
  // EXISTING CITIES (from cities.config.ts)
  {
    ...
    population: 872680,
    description:
      "Professionele webdesign voor Amsterdam ondernemers - volledig online ontwikkeld met videocalls en digitale samenwerking. Van startup tot corporate, wij bedienen alle Amsterdamse bedrijven met moderne webtechnologieën.",
  ...
  },
  {
    ...
    population: 651446,
    description:
      "Webdesign Rotterdam - moderne websites voor bedrijven in de havenstad met innovatieve digitale oplossingen.",
    relatedServices: ALL_SERVICES,
  ...
  },
  {
    ...
    population: 361924,
    description:
      "Website laten maken Utrecht - centraal gelegen webdesign expertise met focus op kwaliteit en performance.",
    relatedServices: ALL_SERVICES,
  ...
  },
  {
    ...
    population: 548320,
    description:
      "Webdesign Den Haag - professionele websites voor overheid, internationale organisaties en bedrijfsleven.",
    relatedServices: ALL_SERVICES,
  ...
  },
  {
    ...
    population: 238326,
    description:
      "Website ontwikkeling Eindhoven - innovatieve weboplossingen in de technologie-hoofdstad Brainport.",
    relatedServices: ALL_SERVICES,
  ...
  },
  {
    ...
    population: 223578,
    description:
      "Webdesign Tilburg - kwaliteitswebsites voor bedrijven in Noord-Brabant met focus op gebruiksvriendelijkheid.",
    relatedServices: ALL_SERVICES,
  ...
  },
  {
    ...
    population: 235287,
    description:
      "Website laten maken Groningen - noordelijke expertise in webdesign met duurzame digitale oplossingen.",
    relatedServices: ALL_SERVICES,
  ...
  },
  {
    ...
    population: 218096,
    description:
      "Webdesign Almere - moderne websites voor de snelstgroeiende stad van Nederland.",
    relatedServices: ALL_SERVICES,
  ...
  },
  {
    ...
    population: 184403,
    description:
      "Webdesign Breda - strategische weboplossingen voor bedrijven in het hart van Noord-Brabant.",
    relatedServices: ALL_SERVICES,
  ...
  },
  {
    ...
    population: 179073,
    description:
      "Webdesign Nijmegen - historische stad, moderne websites met een focus op innovatie en duurzaamheid.",
    relatedServices: ALL_SERVICES,
  ...
  // MISSING CITIES (restored from local-seo.config.ts)
  {
    ...
    population: 162961,
    description:
      "Website laten maken Haarlem - creatieve webdesign voor bloemenstad met rijke geschiedenis.",
    relatedServices: ALL_SERVICES,
  ...
  },
  {
    ...
    population: 161368,
    description:
      "Webdesign Arnhem - moderne websites voor provinciale hoofdstad met groene omgeving.",
    relatedServices: ALL_SERVICES,
  ...
  },
  {
    ...
    population: 156711,
    description:
      "Website ontwikkeling Zaanstad - digitale oplossingen voor industriestad in de Zaanstreek.",
    relatedServices: ALL_SERVICES,
  ...
  },
  {
    ...
    population: 165525,
    description:
      "Website laten maken Apeldoorn - webdesign voor Kroondomein in het hart van de Veluwe.",
    relatedServices: ALL_SERVICES,
  ...
  },
  {
    ...
    population: 158986,
    description:
      "Webdesign Enschede - innovatieve websites voor kennisstad aan de Duitse grens.",
    relatedServices: ALL_SERVICES,
  ...
  },
  {
    ...
    population: 156039,
    description:
      "Website ontwikkeling Haarlemmermeer - moderne weboplossingen voor luchthaven gemeente.",
    relatedServices: ALL_SERVICES,
    ...
    coordinates: { lat: 52.3007, lng: 4.691 },
    characteristics: [
      "luchthaven gemeente",
  ...
  },
  {
    ...
    population: 158531,
    description:
      "Webdesign Amersfoort - strategische websites voor centraal gelegen historische stad.",
    relatedServices: ALL_SERVICES,
  ...
  },
  {
    ...
    population: 119300,
    description:
      "Website laten maken Dordrecht - webdesign voor oudste stad van Holland met maritiem karakter.",
    relatedServices: ALL_SERVICES,
  ...
  },
  {
    ...
    population: 125174,
    description:
      "Webdesign Leiden - academische websites voor universiteitsstad met wereldfaam.",
    relatedServices: ALL_SERVICES,
  ...
  },
  {
    ...
    population: 125283,
    description:
      "Website ontwikkeling Zoetermeer - moderne weboplossingen voor groeiende woonstad.",
    relatedServices: ALL_SERVICES,
  ...
  },
  {
    ...
    population: 132441,
    description:
      "Webdesign Zwolle - strategische websites voor Hanzestad aan de IJssel.",
    relatedServices: ALL_SERVICES,
  ...
  },
  {
    ...
    population: 121558,
    description:
      "Website laten maken Maastricht - Europese webdesign voor oudste stad van Nederland.",
    relatedServices: ALL_SERVICES,
  ...
  },
  {
    ...
    population: 101797,
    description:
      "Webdesign Venlo - grensoverschrijdende websites voor logistieke hoofdstad van Limburg.",
    relatedServices: ALL_SERVICES,
