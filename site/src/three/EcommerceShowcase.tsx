...
function ProductDisplay({ position = [0, 0, 0], productType = 'phone' }: ProductDisplayProps) {
...
export default function EcommerceShowcase({ className = '' }: EcommerceShowcaseProps) {
  return (
