  ...
  describe("Utility Functions", () => {
    ...
    describe("generateImageSitemapXML", () => {
      it("should generate valid XML for image entries", () => {
        ...
        expect(xml).toContain("<image:image>");
        expect(xml).toContain(
          "<image:loc>https://prowebstudio.nl/image.jpg</image:loc>",
        );
        expect(xml).toContain(
          "<image:caption><![CDATA[Test image]]></image:caption>",
        );
        expect(xml).toContain(
          "<image:geo_location>Netherlands</image:geo_location>",
        );
      });
    });
    ...
    describe("generateSitemapIndexXML", () => {
      it("should generate valid sitemap index XML", () => {
        const sitemaps = [
          {
            loc: "https://prowebstudio.nl/sitemap.xml",
            lastmod: new Date("2025-01-15"),
          },
          {
            loc: "https://prowebstudio.nl/sitemap-images.xml",
