...
export const services: ServiceLink[] = [
  ...
  },
  {
    ...
    description:
      "E-commerce platformen met iDEAL integratie en Nederlandse wetgeving",
    relatedServices: [
      "website-laten-maken",
      "seo-optimalisatie",
      "onderhoud-support",
...
export const locations: LocationPage[] = [
  {
    ...
    population: 872680,
    description:
      "Professionele webdesign en ontwikkeling in Amsterdam. Lokale expertise voor Nederlandse bedrijven.",
    relatedServices: [
      "website-laten-maken",
      "webshop-laten-maken",
      "seo-optimalisatie",
  ...
  },
  {
    ...
    population: 651446,
    description:
      "Webdesign Rotterdam - moderne websites voor bedrijven in de havenstad.",
    relatedServices: [
      "website-laten-maken",
      "webshop-laten-maken",
      "seo-optimalisatie",
  ...
  },
  {
    ...
    population: 361924,
    description:
      "Website laten maken Utrecht - centraal gelegen webdesign expertise.",
    relatedServices: [
      "website-laten-maken",
      "webshop-laten-maken",
      "seo-optimalisatie",
  ...
  },
  {
    ...
    population: 548320,
    description:
      "Webdesign Den Haag - professionele websites voor overheid en bedrijfsleven.",
    relatedServices: [
      "website-laten-maken",
      "webshop-laten-maken",
      "seo-optimalisatie",
  ...
  },
  {
    ...
    population: 238326,
    description:
      "Website ontwikkeling Eindhoven - innovatieve weboplossingen in Brainport.",
    relatedServices: [
      "website-laten-maken",
      "webshop-laten-maken",
      "seo-optimalisatie",
  ...
  },
  {
    ...
    population: 223578,
    description:
      "Webdesign Tilburg - kwaliteitswebsites voor bedrijven in Noord-Brabant.",
    relatedServices: [
      "website-laten-maken",
      "webshop-laten-maken",
      "seo-optimalisatie",
  ...
  },
  {
    ...
    population: 235287,
    description:
      "Website laten maken Groningen - noordelijke expertise in webdesign.",
    relatedServices: [
      "website-laten-maken",
      "webshop-laten-maken",
      "seo-optimalisatie",
  ...
  },
  {
    ...
    population: 218096,
    description:
      "Webdesign Almere - moderne websites voor de snelstgroeiende stad.",
    relatedServices: [
      "website-laten-maken",
      "webshop-laten-maken",
      "seo-optimalisatie",
  ...
  },
  {
    ...
    population: 184403,
    description:
      "Website ontwikkeling Breda - professionele weboplossingen in West-Brabant.",
    relatedServices: [
      "website-laten-maken",
      "webshop-laten-maken",
      "seo-optimalisatie",
...
export const footerLinkGroups: LinkGroup[] = [
  ...
  },
  {
    ...
    links: [
      {
        title: "Website Laten Maken Amsterdam",
        href: "/locaties/amsterdam",
        priority: "high",
      },
      {
        title: "Webdesign Rotterdam",
        href: "/locaties/rotterdam",
        priority: "high",
      },
      {
        title: "Website Ontwikkeling Utrecht",
        href: "/locaties/utrecht",
        priority: "high",
      },
      {
        title: "Webdesign Den Haag",
        href: "/locaties/den-haag",
        priority: "medium",
      },
      {
        title: "Website Laten Maken Eindhoven",
  ...
  },
  {
    ...
    links: [
      {
        title: "Nederlandse Webdesign Experts",
        href: "/over-ons",
        priority: "medium",
      },
      {
        title: "Website Ontwikkeling Proces",
        href: "/werkwijze",
        priority: "medium",
      },
      {
        title: "Onze Webdesign Case Studies",
        href: "/portfolio",
        priority: "medium",
      },
...
export const contentSuggestions: Record<
  string,
  Array<{ title: string; href: string; description: string }>
> = {
  "/diensten": [
    {
      title: "Bekijk Ons Portfolio",
      href: "/portfolio",
      description: "Ontdek voorbeelden van onze professionele websites",
    },
    {
      title: "Onze Werkwijze",
      href: "/werkwijze",
      description: "Leer meer over ons transparante ontwikkelproces",
    },
    {
      title: "Neem Contact Op",
      href: "/contact",
      description: "Start vandaag nog met uw nieuwe website project",
    },
  ],
  "/portfolio": [
    {
    ...
    },
    {
      title: "Speeltuin",
      href: "/speeltuin",
      description: "Ervaar interactieve 3D website elementen",
    },
    {
      title: "Plan Een Gesprek",
      href: "/contact",
      description: "Bespreek uw project ideeën met ons team",
    },
  ],
  "/over-ons": [
    {
      title: "Onze Werkwijze",
      href: "/werkwijze",
      description: "Zo werken wij samen aan uw succes",
    },
    {
      title: "Portfolio Bekijken",
      href: "/portfolio",
      description: "Zie wat wij hebben gerealiseerd voor andere klanten",
    },
    {
      title: "Contact Opnemen",
      href: "/contact",
      description: "Laten we kennismaken en uw visie bespreken",
    },
  ],
  "/werkwijze": [
    {
      ...
      href: "/portfolio",
      description: "Resultaten van onze bewezen werkwijze",
    },
    {
      title: "Start Uw Project",
      href: "/contact",
      description: "Begin met een vrijblijvend gesprek",
    },
    {
      title: "Onze Diensten",
      href: "/diensten",
      description: "Complete overzicht van onze mogelijkheden",
    },
  ],
  "/contact": [
    {
      title: "Onze Diensten",
      href: "/diensten",
      description: "Wat kunnen wij voor u betekenen?",
    },
    {
      title: "Portfolio Inzien",
      href: "/portfolio",
      description: "Inspiratie voor uw eigen project",
    },
    {
      title: "Werkwijze Begrijpen",
      href: "/werkwijze",
...
export function getNearbyLocations(currentLocation: string): LocationPage[] {
  ...
  return locations
    .filter((l) => current.nearbyLocations.includes(l.slug))
    .slice(0, 3);
}
