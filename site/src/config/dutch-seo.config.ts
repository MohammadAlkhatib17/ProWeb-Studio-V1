...
export const CONTENT_CLUSTERS = {
  ...
  "webdesign-nederland": {
    ...
    internalLinks: ["/over-ons", "/locaties", "/diensten"],
  },
  "lokale-seo": {
    ...
    internalLinks: ["/diensten/seo-optimalisatie", "/locaties"],
  },
} as const;
...
export const VOICE_SEARCH_FAQS = [
  {
    ...
    answer:
      "De kosten voor een professionele website in Nederland variëren tussen €2.500 en €15.000, afhankelijk van functionaliteiten en complexiteit. Voor MKB bedrijven bieden wij transparante prijspakketten vanaf €2.500.",
    category: "prijzen",
    keywords: [
      "kosten website",
      "prijzen webdesign",
  ...
  },
  {
    ...
    answer:
      "Een professionele website ontwikkelen duurt gemiddeld 4-8 weken, afhankelijk van de scope. Eenvoudige bedrijfswebsites kunnen binnen 3 weken opgeleverd worden, complexere projecten zoals webshops nemen 6-12 weken in beslag.",
    category: "proces",
    keywords: [
      "ontwikkeltijd website",
      "hoe lang website maken",
      "website oplevering",
    ],
    voiceOptimized: true,
  },
  {
    question:
      "Wat is het verschil tussen een goedkope en professionele website?",
    answer:
      "Een professionele website wordt op maat gemaakt, is SEO geoptimaliseerd, mobiel-vriendelijk, veilig en onderhoudsvrij. Goedkope templates missen vaak Nederlandse lokalisatie, goede beveiliging en professionele ondersteuning.",
    category: "kwaliteit",
    keywords: [
      "professionele website",
      "website kwaliteit",
      "verschil goedkoop duur",
    ],
    voiceOptimized: true,
  },
  {
    ...
    answer:
      "Ja, wij leveren alle websites op met een gebruiksvriendelijk beheersysteem. Daarnaast bieden wij Nederlandse ondersteuning en trainingen zodat u zelfstandig content kunt bijwerken.",
    category: "onderhoud",
  ...
  },
  {
    ...
    answer:
      "Wij accepteren alle gangbare Nederlandse betaalmethoden: iDEAL, bankoverschrijving, creditcard en voor bedrijven ook factuurbetalingen. Betalingen kunnen gespreid worden over het project.",
    category: "betaling",
  ...
  },
  {
    ...
    answer:
      "Absoluut! Wij zijn gespecialiseerd in websites voor het Nederlandse MKB, inclusief ZZP-ers, kleine bedrijven en startups. Onze pakketten zijn speciaal ontworpen voor ondernemers die kwaliteit zoeken tegen een eerlijke prijs.",
    category: "doelgroep",
...
export type ContentCluster =
  (typeof CONTENT_CLUSTERS)[keyof typeof CONTENT_CLUSTERS];
