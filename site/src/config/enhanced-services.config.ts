...
export const enhancedServices: EnhancedService[] = [
  {
    ...
    relatedServices: ['webshop-laten-maken', 'seo-optimalisatie', '3d-website-ervaringen', 'onderhoud-support'],
    targetAudience: [
    ...
    pricing: {
      startingFrom: '€2.495',
      description: 'Inclusief ontwerp, ontwikkeling, CMS, SSL, hosting setup en 30 dagen support'
    },
    timeline: '2-4 weken afhankelijk van complexiteit',
    seoKeywords: ['website laten maken', 'webdesign', 'website ontwikkeling', 'responsieve website', 'CMS website']
  },
  {
    title: 'Webshop Laten Maken',
    slug: 'webshop-laten-maken',
    href: '/diensten/webshop-laten-maken',
    description: 'Complete e-commerce platformen met Nederlandse betaalmethoden en juridische compliance',
    detailedDescription: 'Onze webshops zijn gebouwd voor Nederlandse ondernemers die online willen verkopen. We integreren alle populaire betaalmethoden zoals iDEAL, PayPal en creditcards, zorgen voor GDPR-compliance en Nederlandse wetgeving. De volledige ontwikkeling gebeurt online met regelmatige demo\'s via videocalls.',
    benefits: [
    ...
    relatedServices: ['website-laten-maken', 'seo-optimalisatie', 'onderhoud-support', '3d-website-ervaringen'],
    targetAudience: [
    ...
    pricing: {
      startingFrom: '€4.995',
      description: 'Inclusief ontwerp, ontwikkeling, betaalintegraties, producten setup en 60 dagen support'
    },
    timeline: '4-6 weken afhankelijk van productcatalogus grootte',
    seoKeywords: ['webshop laten maken', 'e-commerce website', 'online winkel', 'webwinkel ontwikkeling', 'iDEAL webshop']
  },
  {
    title: 'SEO Optimalisatie',
    slug: 'seo-optimalisatie',
    href: '/diensten/seo-optimalisatie',
    description: 'Lokale en nationale SEO voor maximale vindbaarheid in Google Nederland',
    detailedDescription: 'Onze SEO-expertise is volledig gefocust op de Nederlandse markt. We optimaliseren voor lokale zoektermen, Nederlandse taalpatronen en culturele context. Alle SEO-werkzaamheden worden online uitgevoerd met maandelijkse rapportages en strategische videocalls.',
    benefits: [
    ...
    relatedServices: ['website-laten-maken', 'webshop-laten-maken', 'onderhoud-support', 'content-marketing'],
    targetAudience: [
    ...
    pricing: {
      ...
      description: 'Inclusief keyword research, on-page optimalisatie, technische SEO en maandelijkse rapportages'
    },
    timeline: 'Doorlopend, eerste resultaten binnen 3-6 maanden',
    seoKeywords: ['SEO optimalisatie', 'lokale SEO', 'Google ranking', 'zoekmachine optimalisatie', 'SEO Nederland']
  },
  {
    title: '3D Website Ervaringen',
    slug: '3d-website-ervaringen', 
    href: '/diensten/3d-website-ervaringen',
    description: 'Interactieve 3D visualisaties en immersieve digitale ervaringen',
    detailedDescription: 'Wij specialiseren ons in cutting-edge 3D webtechnologieën die uw bezoekers een onvergetelijke ervaring bieden. Van productconfigurators tot interactieve showrooms, we ontwikkelen alles online met 3D previews en demo\'s via screensharing sessies.',
    benefits: [
    ...
    relatedServices: ['website-laten-maken', 'webshop-laten-maken', 'onderhoud-support', 'ui-ux-design'],
    targetAudience: [
    ...
    pricing: {
      startingFrom: '€3.495',
      description: 'Inclusief 3D ontwerp, ontwikkeling, optimalisatie en integratie met bestaande website'
    },
    timeline: '3-5 weken afhankelijk van 3D complexiteit',
    seoKeywords: ['3D website', 'interactieve visualisatie', '3D product configurator', 'WebGL ontwikkeling', '3D web ervaring']
  },
  {
    title: 'Website Onderhoud & Support',
    slug: 'onderhoud-support',
    href: '/diensten/onderhoud-support',
    description: 'Doorlopend technisch onderhoud, updates en professionele website support',
    detailedDescription: 'Onze onderhoudsservice zorgt ervoor dat uw website altijd up-to-date, veilig en optimaal blijft presteren. We bieden verschillende support pakketten met snelle responstijden via online kanalen, proactieve monitoring en regelmatige updates.',
    benefits: [
    ...
    relatedServices: ['website-laten-maken', 'webshop-laten-maken', 'seo-optimalisatie', 'hosting-services'],
    targetAudience: [
    ...
    pricing: {
      ...
      description: 'Inclusief monitoring, updates, backups, support tickets en maandelijkse rapportages'
    },
    timeline: 'Doorlopende service vanaf eerste werkdag',
    seoKeywords: ['website onderhoud', 'website support', 'technisch beheer', 'website maintenance', 'WordPress onderhoud']
  },
  {
    title: 'Content Marketing & Copywriting',
    slug: 'content-marketing',
    href: '/diensten/content-marketing',
    description: 'Professionele Nederlandse content die converteert en rankt in Google',
    detailedDescription: 'Onze content specialisten creëren hoogwaardige Nederlandse teksten die zowel uw doelgroep aanspreken als Google helpen uw website beter te ranken. Van blog artikelen tot productbeschrijvingen, alles wordt online ontwikkeld met focus op Nederlandse taal en cultuur.',
    benefits: [
    ...
    relatedServices: ['seo-optimalisatie', 'website-laten-maken', 'social-media-marketing', 'email-marketing'],
    targetAudience: [
    ...
    pricing: {
      ...
      description: 'Inclusief 4 blog artikelen, SEO optimalisatie, content planning en maandelijkse rapportage'
    },
    timeline: 'Doorlopend, eerste artikelen binnen 1 week na start',
    seoKeywords: ['content marketing', 'copywriting Nederland', 'blog artikelen', 'SEO content', 'Nederlandse copywriter']
  },
  {
    title: 'UI/UX Design Services',
    slug: 'ui-ux-design',
    href: '/diensten/ui-ux-design',
    description: 'Gebruiksvriendelijke interface design en optimale user experience',
    detailedDescription: 'Onze UI/UX designers creëren intuïtieve en visueel aantrekkelijke interfaces die gebruikers leiden naar conversie. We werken volledig online met design tools, prototype demo\'s en gebruikerstests via remote sessies.',
    benefits: [
    ...
    relatedServices: ['website-laten-maken', '3d-website-ervaringen', 'conversion-optimalisatie', 'branding-services'],
    targetAudience: [
    ...
    pricing: {
      startingFrom: '€2.195',
      description: 'Inclusief user research, wireframes, visual design, prototype en developer handoff'
    },
    timeline: '3-4 weken afhankelijk van project scope',
    seoKeywords: ['UI UX design', 'interface design', 'user experience', 'wireframe ontwerp', 'usability testing']
  },
  {
    title: 'Conversion Rate Optimalisatie',
    slug: 'conversion-optimalisatie',
    href: '/diensten/conversion-optimalisatie',
    description: 'Data-gedreven optimalisatie voor meer bezoekers naar klanten conversie',
    detailedDescription: 'We analyseren uw website data om te ontdekken waarom bezoekers niet converteren en implementeren bewezen optimalisaties. Alle testing en analyse gebeurt online met regelmatige rapportages en strategische videocalls voor resultaatbespreking.',
    benefits: [
    ...
    relatedServices: ['ui-ux-design', 'seo-optimalisatie', 'webshop-laten-maken', 'analytics-setup'],
    targetAudience: [
    ...
    pricing: {
      ...
      description: 'Inclusief conversion audit, A/B testing setup, monitoring en maandelijkse optimalisaties'
    },
    timeline: 'Doorlopend programma, eerste tests binnen 2 weken',
    seoKeywords: ['conversion optimalisatie', 'A/B testing', 'conversie verbetering', 'landing page optimalisatie', 'checkout optimalisatie']
  }
];
 ...
 */
export function getRelatedServices(currentServiceSlug: string): EnhancedService[] {
...
export const serviceCategories = [
  {
    ...
    services: ['website-laten-maken', 'webshop-laten-maken', '3d-website-ervaringen']
  },
  {
    name: 'Marketing & SEO',
    services: ['seo-optimalisatie', 'content-marketing', 'conversion-optimalisatie']
  },
  {
    name: 'Design & Support',
