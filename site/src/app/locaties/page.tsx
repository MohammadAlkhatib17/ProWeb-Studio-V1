...
export const metadata: Metadata = {
  ...
  description:
    "ProWeb Studio biedt professionele webdesign diensten in heel Nederland. Van Amsterdam tot Rotterdam, Utrecht tot Den Haag - lokale expertise voor uw website project.",
  alternates: {
    canonical: "/locaties",
    languages: {
      "nl-NL": "/locaties",
  ...
  openGraph: {
    ...
    description:
      "Lokale webdesign expertise in alle grote Nederlandse steden. Maatwerk websites met persoonlijke service.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-400 max-w-2xl mx-auto">
              Van de Randstad tot Brabant, van Groningen tot Zeeland - wij
              bieden lokale service met nationale expertise.
            </p>
          </div>
      ...
      <section className="py-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-400 max-w-2xl mx-auto">
              Bekijk onze complete dekking door heel Nederland met lokale SEO
              optimalisatie voor elke stad.
            </p>
          ...
          <div className="text-center">
            <div className="bg-cosmic-800/30 border border-cosmic-700/50 rounded-lg p-8">
              ...
              <p className="text-slate-400 mb-6">
                Wij bieden lokale SEO geoptimaliseerde landing pages voor alle
      ...
      <section className="py-section bg-gradient-to-r from-cosmic-900 to-cosmic-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-slate-200 mb-8 leading-relaxed">
            Geen probleem! We werken met klanten door heel Nederland. Dankzij
            moderne technologie en bewezen processen leveren we overal dezelfde
            hoge kwaliteit.
          </p>
        ...
        customSuggestions={[
          {
            ...
            href: "/diensten",
            description: "Ontdek wat wij voor uw bedrijf kunnen betekenen",
          },
          {
            title: "Portfolio Bekijken",
            href: "/portfolio",
            description:
              "Zie voorbeelden van ons werk voor Nederlandse bedrijven",
          },
          {
            title: "Werkwijze Leren",
            href: "/werkwijze",
            description: "Hoe wij samen tot het beste resultaat komen",
          },
        ]}
      />
    </main>
