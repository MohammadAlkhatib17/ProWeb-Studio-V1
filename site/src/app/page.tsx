    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Website Laten Maken Nederland | ProWeb Studio',
        type: 'image/png',
      },
    ],
    title:
...
// Import the optimized hero component
const OptimizedHero = dynamicImport(() => import('@/components/hero/OptimizedHero'), {
  ssr: false,
  loading: () => null,
});
          ...
          <article className="prose prose-invert prose-lg max-w-none">
            ...
            <section>
              ...
              <p className="text-slate-200 mb-8">
                ...
                of ontdek onze{' '}
                <Link href="/prijzen" className="text-cyan-300 hover:text-cyan-300">
                  transparante website prijzen
                </Link>{' '}
            ...
            <footer className="bg-gradient-to-r from-cyan-500/10 to-magenta-500/10 p-8 rounded-xl border border-cyan-500/20 text-center">
              ...
              <p className="text-slate-200 mb-6">
                ...
                Bekijk onze <Link href="/prijzen" className="text-cyan-300 hover:text-cyan-300">transparante prijzen</Link> of ontdek waarom ambitieuze ondernemers door heel Nederland kiezen voor onze 
