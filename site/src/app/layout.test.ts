...
describe('Verification Meta Tags', () => {
  ...
  it('should not contain any placeholder strings', () => {
    ...
    expect(JSON.stringify(verification)).not.toContain('GOOGLE_VERIFICATION_CODE_PLACEHOLDER');
    expect(JSON.stringify(verification)).not.toContain('BING_VERIFICATION_CODE_PLACEHOLDER');
    expect(JSON.stringify(verification)).not.toContain('YANDEX_VERIFICATION_CODE_PLACEHOLDER');
  });
});