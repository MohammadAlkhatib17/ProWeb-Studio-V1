...
const steps = [
  {
    ...
    details: 'Uitgebreide analyse van uw bedrijfsdoelen, doelgroep en concurrentie',
    icon: '🎯',
    duration: '1-2 weken',
  ...
  { 
    ...
    details: 'Technische architectuur, user experience strategie en performance goals',
    icon: '🚀',
    duration: '1 week',
  ...
  { 
    ...
    details: 'Moderne designs met focus op gebruikerservaring en merkidentiteit',
    icon: '🎨',
    duration: '2-3 weken',
  ...
  { 
    ...
    details: 'Moderne technologieën, optimale performance en toekomstbestendige code',
    icon: '⚡',
    duration: '3-5 weken',
  ...
  { 
    ...
    details: 'Cross-browser testing, performance optimalisatie en security audits',
    icon: '🔍',
    duration: '1 week',
  ...
  { 
    ...
    details: 'Data-analyse, conversie optimalisatie en technische ondersteuning',
    icon: '📈',
    duration: 'Doorlopend',
    ...
    <PageLayout>
      ...
      <SectionLayout variant="hero">
        <div className="text-center mb-16">
          ...
          <BodyText className="max-w-3xl mx-auto text-center text-xl text-cyan-300 mb-12">
            Een bewezen proces dat resultaat garandeert. Transparante communicatie, 
            vaste prijzen en Nederlandse kwaliteit in elke fase.
          </BodyText>
        </div>
          ...
          <div className="relative">
            ...
            {steps.map((step, index) => (
              <div key={index} className={`relative flex items-center mb-16 ${index % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                ...
                {/* Step content card */}
                <div className={`glass p-8 rounded-2xl ml-20 md:ml-0 md:w-5/12 hover:border-cyan-500/50 hover:bg-white/10 transition-all duration-500 group ${index % 2 === 0 ? 'md:mr-auto md:text-right' : 'md:ml-auto md:text-left'}`}>
                  ...
                  <p className="text-lg text-cyan-300 mb-4">{step.description}</p>
                  <p className="text-slate-300 mb-6 leading-relaxed">{step.details}</p>
                  
                  {/* Deliverables */}
                  <div>
                    <h4 className="text-sm font-semibold text-white mb-3 opacity-80">Deliverables:</h4>
                    <div className="flex flex-wrap gap-2">
                      {step.deliverables.map((deliverable, idx) => (
                        <span key={idx} className="px-3 py-1 bg-cyan-500/20 text-cyan-300 text-sm rounded-full border border-cyan-500/30">
                          {deliverable}
                        </span>
                      ))}
                    </div>
            ...
            <div className="glass p-8 rounded-2xl hover:border-cyan-500/60 transition-all duration-500 h-full relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-300 leading-relaxed text-center mb-6">
                  Open communicatie tijdens het hele proces. Je weet altijd waar we staan.
                </p>
          ...
          <div className="group relative">
            <div className="glass p-8 rounded-2xl hover:border-magenta-500/60 transition-all duration-500 h-full relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-300 leading-relaxed text-center mb-6">
                  We gebruiken de nieuwste technologieën om je voorsprong te geven.
                </p>
          ...
          <div className="group relative">
            <div className="glass p-8 rounded-2xl hover:border-magenta-500/60 transition-all duration-500 h-full relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-300 leading-relaxed text-center mb-6">
                  We zijn niet alleen leverancier, maar strategische partner in jouw groei.
                </p>
        ...
        <div className="text-center mt-16">
          <div className="glass p-8 rounded-2xl max-w-4xl mx-auto">
            ...
            <p className="text-slate-300 mb-8 text-lg">
              Ontdek hoe onze bewezen werkwijze uw digitale ambities werkelijkheid maakt.
            </p>
            <Button href="/contact" variant="primary" size="large" className="mr-4">
              Start Uw Project
            </Button>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-20">
            <div className="glass p-6 rounded-xl text-center group hover:border-cyan-500/50 transition-all duration-300">
              ...
              <h3 className="text-lg font-semibold text-white mb-3">Snelle Resultaten</h3>
              <p className="text-slate-300 text-sm">Efficiënte processen zorgen voor kortere doorlooptijden</p>
            </div>
            
            <div className="glass p-6 rounded-xl text-center group hover:border-magenta-500/50 transition-all duration-300">
              <div className="text-4xl mb-4">🎯</div>
              <h3 className="text-lg font-semibold text-white mb-3">Voorspelbare Kosten</h3>
              <p className="text-slate-300 text-sm">Transparante prijzen zonder verrassingen achteraf</p>
            </div>
            
            <div className="glass p-6 rounded-xl text-center group hover:border-cyan-500/50 transition-all duration-300">
              <div className="text-4xl mb-4">📈</div>
              <h3 className="text-lg font-semibold text-white mb-3">Meetbare ROI</h3>
              <p className="text-slate-300 text-sm">Data-gedreven aanpak voor maximale business impact</p>
            </div>
          </div>
              ...
              {[
                {
                  ...
                  description: "Tijdens deze cruciale eerste fase duiken we diep in uw visie en doelstellingen, zodat we een website kunnen bouwen die perfect aansluit bij uw bedrijfsstrategie en doelgroep.",
                  color: "cyan"
                },
                {
                  step: "02", 
                  title: "Strategie & Planning",
                  description: "We ontwikkelen een data-gedreven plan voor maximale impact, waardoor uw investering in een nieuwe website direct bijdraagt aan uw bedrijfsdoelen en ROI.",
                  color: "magenta"
                },
                {
                  step: "03",
                  title: "Creatief Design",
                  description: "Ons team creëert een visueel ontwerp dat uw merk versterkt en gebruikers overtuigt, resulterend in een professionele uitstraling die vertrouwen en conversie bevordert.",
                  color: "cyan"
                },
                {
                  step: "04",
                  title: "Development & Build",
                  description: "We schrijven clean code en bouwen voor de toekomst, zodat uw website niet alleen vandaag perfect functioneert maar ook schaalbaar is voor toekomstige groei.",
                  color: "magenta"
                },
                {
                  step: "05",
                  title: "Testing & QA",
                  description: "Door rigoureus testen garanderen we perfecte prestaties op alle apparaten en browsers, waardoor uw bezoekers altijd een optimale gebruikerservaring hebben.",
                  color: "cyan"
                },
                {
                  step: "06",
                  title: "Launch & Go-Live",
                  description: "Onze soepele deployment en go-live begeleiding zorgen ervoor dat uw website probleemloos online gaat zonder downtime of technische problemen.",
                  color: "magenta"
                },
                {
                  step: "07",
                  title: "Growth & Optimization",
                  description: "Continue optimalisatie en ondersteuning helpen uw website groeien met uw bedrijf, met regelmatige updates en prestatieverbeteringen.",
                  color: "cyan"
                }
              ].map((phase, index) => (
                <div key={index} id={`stap-${index + 1}`} className={`glass p-8 rounded-xl hover:border-${phase.color}-500/50 transition-all duration-300 group`}>
                  <div className="flex items-start space-x-6">
                    <div className={`flex-shrink-0 w-16 h-16 rounded-full bg-gradient-to-br from-${phase.color}-500/20 to-${phase.color}-600/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
                      <span className={`text-2xl font-bold text-${phase.color}-300`}>{phase.step}</span>
                    </div>
                    <div className="flex-1">
                      <h3 className={`text-xl font-bold text-white mb-3 group-hover:text-${phase.color}-300 transition-colors duration-300`}>
                        {phase.title}
                      </h3>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <BodyText className="text-lg leading-relaxed mb-6">
                  ...
                  en gegarandeerde kwaliteit door onze bewezen methodiek.
                </BodyText>
                
                <BodyText className="text-lg leading-relaxed">
                  Dit stappenplan website bouwen heeft al tientallen Nederlandse bedrijven
                  geholpen hun online doelen te bereiken. Door deze transparante
                  werkwijze weet u precies wat u kunt verwachten en wanneer.
                </BodyText>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center p-4 rounded-lg bg-cyan-500/10 border border-cyan-500/20">
                  ...
                  <span className="text-cyan-300 font-medium">100% transparante communicatie</span>
                </div>
                <div className="flex items-center p-4 rounded-lg bg-magenta-500/10 border border-magenta-500/20">
                  <div className="text-2xl mr-4">✓</div>
                  <span className="text-magenta-400 font-medium">Vaste prijzen zonder bijkomende kosten</span>
                </div>
                <div className="flex items-center p-4 rounded-lg bg-cyan-500/10 border border-cyan-500/20">
                  <div className="text-2xl mr-4">✓</div>
                  <span className="text-cyan-300 font-medium">Nederlandse kwaliteitsnormen</span>
                </div>
                <div className="flex items-center p-4 rounded-lg bg-magenta-500/10 border border-magenta-500/20">
                  <div className="text-2xl mr-4">✓</div>
                  <span className="text-magenta-400 font-medium">Doorlopende ondersteuning na launch</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            <div className="glass p-8 rounded-2xl bg-gradient-to-br from-cyan-500/5 to-magenta-500/5 border border-cyan-500/20">
              ...
              <BodyText className="text-lg mb-8 max-w-2xl mx-auto">
                Ontdek hoe onze bewezen werkwijze uw visie omzet in een krachtige,
                resultaatgerichte website die uw bedrijf naar het volgende niveau brengt.
              </BodyText>
              ...
              <div className="mt-6 pt-6 border-t border-white/10">
                <Button href="/speeltuin" variant="secondary" className="inline-flex items-center">
      ...
      <SectionLayout variant="alternate">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <SectionTitle className="mb-6">Veelgestelde Vragen over Onze Werkwijze</SectionTitle>
          ...
          <div className="space-y-6">
            ...
            <div className="glass p-8 rounded-xl group hover:border-cyan-500/50 transition-all duration-300">
              ...
              <p className="text-slate-300 leading-relaxed">
                Een gemiddeld project doorloopt ons proces in 8-12 weken, afhankelijk van de complexiteit 
                en omvang. Tijdens de intake maken we een gedetailleerde planning specifiek voor uw project, 
            ...
            <div className="glass p-8 rounded-xl group hover:border-magenta-500/50 transition-all duration-300">
              ...
              <p className="text-slate-300 leading-relaxed">
                Flexibiliteit is belangrijk. Kleinere aanpassingen worden direct doorgevoerd. Voor grotere 
                wijzigingen bespreken we de impact op planning en budget transparant, zodat u altijd een 
            ...
            <div className="glass p-8 rounded-xl group hover:border-cyan-500/50 transition-all duration-300">
              ...
              <p className="text-slate-300 leading-relaxed">
                U krijgt wekelijkse updates via e-mail en toegang tot ons projectportaal waar u real-time 
                de voortgang kunt volgen. Daarnaast plannen we wekelijkse check-in gesprekken om alles 
            ...
            <div className="glass p-8 rounded-xl group hover:border-magenta-500/50 transition-all duration-300">
              ...
              <p className="text-slate-300 leading-relaxed">
                Na de launch start onze groei-fase. We monitoren de performance, analyseren gebruikersdata 
                en optimaliseren waar nodig. Daarnaast bieden we doorlopende technische ondersteuning en 
                strategisch advies om uw online succes te maximaliseren.
              </p>
            </div>
          </div>
          ...
          <div className="text-center mt-16">
            <div className="inline-flex items-center space-x-4 glass p-6 rounded-xl">
              ...
              <div className="text-left">
                <h4 className="text-lg font-semibold text-white">Nog meer vragen?</h4>
                <p className="text-slate-300 text-sm">We beantwoorden ze graag persoonlijk</p>
              </div>
