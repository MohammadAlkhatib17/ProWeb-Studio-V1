...
const AboutScene = dynamicImport(() => import("@/three/AboutScene"), {
  ssr: false,
  loading: () => (
    <div className="absolute inset-0 bg-gradient-to-br from-cosmic-900/50 to-cosmic-800/30 animate-pulse" />
  ),
});
...
export const metadata: Metadata = {
  ...
  description:
    "Ontdek de visie en missie van ProWeb Studio. Wij combineren geavanceerde technologie met creatief design om de digitale grenzen te verleggen voor Nederlandse bedrijven.",
  alternates: {
    canonical: "/over-ons",
  ...
  openGraph: {
    ...
    description:
      "Leer ons team en onze filosofie kennen. Wij bouwen de websites van morgen, vandaag.",
      ...
      >
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <p
            ...
            "
          >
            Wij zijn ProWeb Studio. We zijn een team van strategen, ontwerpers
            en ontwikkelaars met een gedeelde passie: het bouwen van
            buitengewone digitale ervaringen.
          </p>
        </div>
      </section>
          ...
          <div className="max-w-[800px] text-center">
            ...
            <div className="space-y-4 text-slate-300 leading-relaxed text-base md:text-lg">
              <p>
                ...
                Maar onze passie ligt niet in het herhalen van wat al bestaat.
                Wij geloven in vooruitgang. In het verleggen van grenzen.
              </p>
              <p>
                Waarom vasthouden aan traditionele oplossingen als de
                technologie van morgen vandaag al binnen handbereik is? ProWeb
                Studio is opgericht om die toekomst te bouwen. Wij kiezen bewust
                voor de meest geavanceerde, performante en meeslepende
                technologieën, niet omdat het kan, maar omdat het uw merk de
                voorsprong geeft die het verdient.
              </p>
            </div>
          </div>
        </div>
