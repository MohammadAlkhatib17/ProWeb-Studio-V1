...
export const metadata: Metadata = generateMetadata('/diensten/3d-website-ervaringen', {
...
const servicePageData: ServicePageProps = {
  ...
  subtitle: 'Immersieve 3D experiences die indruk maken',
  heroDescription: 'Van 3D product configurators tot interactieve virtual showrooms - wij creëren cutting-edge 3D webervaringen die uw bezoekers betrekken en converteren.',
  primaryCTA: 'Gratis 3D Demo',
  secondaryCTA: 'Bekijk 3D Cases',
  ...
  // SEO
  pageSlug: '3d-website-ervaringen'
};

export default function DrieD_WebsiteErvaringen() {
