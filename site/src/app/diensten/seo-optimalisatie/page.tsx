...
export const metadata: Metadata = generateMetadata('/diensten/seo-optimalisatie', {
...
const servicePageData: ServicePageProps = {
  ...
  heroDescription: 'Technische SEO, content optimalisatie en link building voor duurzame organische groei. Professionele zoekmachine optimalisatie die meetbare resultaten levert.',
  primaryCTA: 'Gratis SEO Analyse',
  secondaryCTA: 'SEO Voorbeelden',
  
  // Features Section
  featuresTitle: 'Volledige SEO Service',
  featuresSubtitle: 'Van technische optimalisatie tot content strategie - wij zorgen voor alle aspecten van moderne zoekmachine optimalisatie.',
  features: [
    {
      title: 'Technische SEO',
      description: 'Complete technische optimalisatie voor betere crawlability en indexering',
      icon: '�',
      details: [
  ...
  packagesSubtitle: 'Van eenmalige audit tot doorlopende SEO begeleiding - kies het pakket dat bij uw doelen past.',
  packages: [
    {
      name: 'SEO Audit',
  ...
  processSteps: [
    {
      ...
      description: 'Complete technische audit, keyword research en concurrentie analyse voor een solide SEO strategie.'
    },
    {
      step: '02',
      title: 'Strategie Ontwikkeling',
      description: 'SEO roadmap en actieplan gebaseerd op audit bevindingen en bedrijfsdoelstellingen.'
    },
    {
      step: '03',
      title: 'Implementatie',
      description: 'Technische fixes, on-page optimalisatie en content verbetering volgens best practices.'
    },
    {
      step: '04',
      title: 'Monitoring & Optimalisatie',
      description: 'Continue monitoring, rapportage en iteratieve verbeteringen voor duurzame resultaten.'
    },
    {
      step: '06',
  ...
  trustIndicators: [
    {
      ...
      description: 'Gecertificeerde SEO professionals met diepgaande tool kennis en bewezen expertise.'
    },
    {
      icon: '🎯',
      title: 'Technische SEO Specialisten',
      description: 'Ervaren developers en SEO experts die technische en strategische optimalisatie combineren.'
    },
    {
      icon: '⚡',
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: 'We monitoren rankings, organisch verkeer, conversies, Core Web Vitals en technische website gezondheid. Maandelijkse rapportages tonen concrete vooruitgang met actionable insights en aanbevelingen voor verdere verbetering.'
    },
    {
      question: 'Doen jullie ook lokale SEO?',
      answer: 'Ja, we zijn gespecialiseerd in lokale SEO voor Nederlandse bedrijven. Dit omvat Google Business Profile optimalisatie, lokale citations, review management en geo-gerichte content strategie voor betere lokale vindbaarheid.'
    },
    {
      question: 'Welke SEO tools gebruiken jullie?',
      answer: 'We werken met professionele SEO tools zoals Google Analytics 4, Search Console, Screaming Frog, Ahrefs, SEMrush en proprietary tracking systemen voor uitgebreide analyse en monitoring van SEO prestaties.'
    }
  ],
  
  // Final CTA Section
  finalCTATitle: 'Klaar om uw Google rankings te verbeteren?',
  finalCTADescription: 'Ontvang een gratis SEO analyse en ontdek hoe wij uw website naar de top van Google kunnen brengen.',
