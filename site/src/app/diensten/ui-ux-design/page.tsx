...
const servicePageData: ServicePageProps = {
  ...
  heroDescription:
    "Van wireframes tot clickable prototypes - wij ontwerpen intuïtieve gebruikerservaringen die uw bezoekers omzetten naar klanten. Data-driven design met focus op conversie.",
