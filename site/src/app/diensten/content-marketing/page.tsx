...
const servicePageData: ServicePageProps = {
  ...
  heroDescription:
    "Van blog artikelen tot social media content - wij creëren waardevolle content die uw doelgroep betrekt en converteert. SEO-geoptimaliseerd en data-driven.",
  ...
  featuresSubtitle:
    "Van contentplanning tot prestatiemonitoring - wij zorgen voor alle aspecten van succesvolle content marketing.",
  features: [
    {
