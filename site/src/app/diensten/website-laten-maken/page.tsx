...
const servicePageData: ServicePageProps = {
  ...
  heroDescription:
    "Van concept tot lancering - wij creëren responsive, snelle en SEO-geoptimaliseerde websites die uw bedrijf online laten excelleren in de Nederlandse markt.",
  ...
  featuresSubtitle:
    "Wij combineren creatief design met moderne technologie om websites te bouwen die niet alleen mooi zijn, maar ook presteren.",
  features: [
    {
      title: "Responsive Webdesign",
      description:
        "Websites die perfect werken op alle apparaten - van smartphone tot desktop",
      icon: "📱",
      details: [
    ...
    },
    {
      ...
      description:
        "Technische SEO en content-optimalisatie voor hogere Google rankings",
      icon: "🔍",
      details: [
    ...
    },
    {
      ...
      description:
        "Eenvoudig uw website beheren met gebruisvriendelijke CMS-systemen",
      icon: "✏️",
      details: [
  ...
  packagesSubtitle:
    "Professionele websites voor elke bedrijfsbehoefte en budget.",
  serviceTypes: [
    {
      type: "Bedrijfswebsite",
      description:
        "Professionele corporate websites voor MKB en grote bedrijven",
      features: [
        "Corporate branding",
        "Team pagina's",
        "Nieuwsmodule",
    ...
    },
    {
      ...
      description:
        "Creatieve portfolio's voor kunstenaars, fotografen en designers",
      features: [
    ...
    },
    {
      type: "Blog Platform",
      description:
        "Content-gerichte websites met uitgebreide blog functionaliteiten",
      features: [
        "CMS integratie",
        "SEO tools",
        "Social sharing",
  ...
  processSubtitle:
    "Van eerste idee tot live website - zo werken wij aan uw online succes.",
  processSteps: [
    {
      step: "01",
      title: "Online Kennismakingsgesprek",
      description:
        "Uitgebreide intake via videocall om uw wensen, doelen en budget te bespreken voor een perfect passende website.",
    },
    {
      step: "02",
      title: "Digitale Strategie & Design",
      description:
        "Wireframing, visual design en user experience planning met online feedback rondes voor optimale resultaten.",
    },
    {
      step: "03",
      title: "Technische Ontwikkeling",
      description:
        "Professionele ontwikkeling met moderne technologieën, live preview en uitgebreide testing op alle apparaten.",
    },
    {
      step: "04",
      title: "SEO & Performance Optimalisatie",
      description:
        "Technische SEO implementatie, snelheidsoptimalisatie en Core Web Vitals configuratie.",
    },
    {
      step: "05",
      title: "Lancering & Training",
      description:
        "Website lancering met volledige documentatie, CMS training en 30 dagen gratis support.",
    },
    {
      step: "06",
  ...
  trustIndicators: [
    {
      ...
      description:
        "Specialisten in de Nederlandse markt met begrip voor lokale business cultuur en gebruikersgedrag.",
    },
    {
      icon: "🚀",
      title: "Bewezen Performance",
      description:
        "Gemiddeld 300% meer online leads en 40% betere conversie rates na website lancering.",
    },
    {
      icon: "🛡️",
      title: "Volledige Transparantie",
      description:
        "Geen verborgen kosten, duidelijke communicatie en 100% eigendom van uw website en content.",
    },
  ],
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "Ja, we implementeren gebruiksvriendelijke CMS-systemen waarmee u eenvoudig content kunt toevoegen, bewerken en verwijderen. We verzorgen ook uitgebreide online training via screensharing zodat u zelfstandig uw website kunt beheren en updaten.",
    },
    {
      question: "Is mijn website geoptimaliseerd voor Google (SEO)?",
      answer:
        "Alle websites worden standaard geoptimaliseerd voor zoekmachines. Dit omvat technische SEO, snelle laadtijden, mobile-vriendelijkheid, proper schema markup en basis content optimalisatie. Voor uitgebreide SEO campagnes hebben we separate pakketten beschikbaar.",
    },
    {
      question: "Wat voor ondersteuning krijg ik na de lancering?",
      answer:
        "Elke website komt met 30 dagen gratis support na lancering. Daarnaast bieden we doorlopende onderhouds- en supportpakketten voor hosting, updates, backups en technische ondersteuning. We zijn altijd bereikbaar voor vragen of aanpassingen.",
    },
  ],
  ...
  finalCTADescription:
    "Krijg een gratis website audit en persoonlijk advies voor uw online aanwezigheid. Geen verplichtingen, wel concrete aanbevelingen.",
