...
export const metadata: Metadata = {
  title:
    "Website laten maken & Webshop bouwen | Nederlandse webdesign diensten – ProWeb Studio",
  description:
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-12">
            <div className="glass p-6 rounded-xl hover:border-cyan-500/60 transition-all duration-300 group">
              ...
              <p className="text-slate-200 mb-4 text-sm leading-relaxed">
                Ontdek hoe wij van idee naar realisatie werken. Van strategische
                planning tot technische implementatie en doorlopende
                optimalisatie.
              </p>
              <Link
                href="/werkwijze"
            ...
            <div className="glass p-6 rounded-xl hover:border-cyan-500/60 transition-all duration-300 group">
              ...
              <p className="text-slate-200 mb-4 text-sm leading-relaxed">
                Ervaar de kracht van moderne webtechnologie. Interactieve
                3D-ervaringen, WebGL-experimenten en innovatieve
            ...
            <div className="glass p-6 rounded-xl hover:border-cyan-500/60 transition-all duration-300 group">
              ...
              <p className="text-slate-200 mb-4 text-sm leading-relaxed">
                Leer het team kennen achter de innovatieve weboplossingen. Onze
                missie, visie en de expertise die we inzetten voor uw digitale
                succes.
              </p>
              <Link
                href="/over-ons"
          ...
          <div className="text-center">
            ...
            <p className="text-slate-200 mb-6 max-w-2xl mx-auto">
              Van concept tot conversie - wij realiseren digitale oplossingen
              die uw bedrijf naar het volgende niveau tillen. Plan een gratis
              strategiesessie en ontdek de mogelijkheden.
            </p>
      ...
      <SectionLayout variant="alternate">
          ...
          >
            ...
            <p>
              ...
              snelheid, gebruiksvriendelijkheid en een conversiegericht ontwerp
              dat bezoekers omzet in klanten. Of u nu ZZP&apos;er bent of een
              groeiend MKB-bedrijf runt, uw online groei is onze prioriteit.
            </p>
            <h2>3D Web Experiences (WebGL/Three.js)</h2>
            <p>
              Onderscheid uw merk met interactieve 3D-ervaringen die uw
              producten en diensten tot leven brengen. Door WebGL en Three.js
              technologie slim in te zetten, creëren we meeslepende
              gebruikerservaringen die langer op uw website blijven hangen.
              Perfect voor bedrijven die hun merkverhaal op een unieke manier
              willen vertellen en een blijvende indruk willen maken.
            </p>
            <h2>Performance Optimalisatie</h2>
            <p>
              Een snelle website is essentieel voor een hogere ranking in Google
              en betere gebruikerservaring. Wij optimaliseren uw Core Web
              Vitals, implementeren geavanceerde caching strategieën en
              gebruiken moderne beeldformaten zoals AVIF en WebP. Het resultaat:
              een bliksemsnelle website die zowel gebruikers als zoekmachines
              tevreden houdt.
            </p>
            <h2>SEO &amp; Content Strategie</h2>
            <p>
              Zichtbaarheid in Google begint met een solide SEO-strategie. Wij
              voeren diepgaand zoekwoordenonderzoek uit, optimaliseren
              technische aspecten en ontwikkelen een contentplan dat uw
              doelgroep aanspreekt. Van lokale SEO voor Nederlandse bedrijven
              tot internationale groei – wij zorgen ervoor dat uw website
              gevonden wordt door de juiste klanten.
            </p>
            <h2>Headless CMS &amp; Integraties</h2>
            <p>
              Flexibel contentbeheer is de sleutel tot efficiënte online
              communicatie. Met headless CMS-oplossingen zoals Sanity of
              Contentful krijgt u volledige controle over uw content, zonder
              technische beperkingen. Wij integreren naadloos met uw bestaande
              systemen en zorgen voor een workflow die aansluit bij uw
              bedrijfsprocessen.
            </p>
            <h2>CRO (Conversion Rate Optimization)</h2>
            <p>
              Meer bezoekers is mooi, maar meer klanten is beter. Door
              systematische A/B-testing, gebruikersanalyse en UX-verbeteringen
              transformeren we uw website van een digitale brochure naar een
