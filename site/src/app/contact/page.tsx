    ...
    <PageLayout className="relative overflow-hidden">
      ...
      <SectionLayout variant="content" id="seo-content">
        <div className="prose prose-invert max-w-none">
          ...
          <BodyText>
            Vertel kort uw doel, doelgroep en gewenste deadline. We denken mee
            en komen met een concreet voorstel.
          </BodyText>

          <SectionTitle>Hoe wilt u contact?</SectionTitle>
          <ul className="space-y-3 text-slate-200">
            <li>
              <strong className="text-cyan-300">Formulier:</strong> naam,
              e‑mail, telefoon (optioneel), projecttype, bericht.
            </li>
            <li>
              <strong className="text-cyan-300">Afspraak plannen:</strong>{" "}
              direct via onze agenda.
            </li>
            <li>
              <strong className="text-cyan-300">E‑mail/telefoon:</strong>{" "}
              contact@prowebstudio.nl — +31686412430.
            </li>
          </ul>

          <SectionTitle>Wat gebeurt er daarna?</SectionTitle>
          <BodyText>
            We bevestigen ontvangst, plannen een call en leveren na de intake
            een duidelijke scope en planning.
          </BodyText>
          ...
          <div className="space-y-4">
            ...
            <BodyText>
              <strong className="text-cyan-300">Kunnen we NDA tekenen?</strong>{" "}
              Ja, op verzoek.
            </BodyText>
            <BodyText>
              <strong className="text-cyan-300">
