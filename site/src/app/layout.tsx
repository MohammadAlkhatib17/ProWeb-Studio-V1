...
export const metadata: Metadata = {
  ...
  description:
    "Wij ontwerpen en bouwen snelle, veilige en schaalbare 3D‑websites die scoren in Google en converteren. Nederlandse kwaliteit, transparante prijzen. Vraag direct offerte aan!",
  keywords: [
  ...
  twitter: {
    ...
    description:
      "Snelle, veilige en schaalbare 3D‑websites die scoren in Google. Nederlandse kwaliteit, transparante prijzen. Vraag direct offerte aan!",
    images: [
      {
        url: `${SITE_URL}/og`,
        width: 1200,
  ...
  other: {
    ...
    "dc.subject":
      "Website Development, Web Design, 3D Websites, Nederlandse Webdesign",
    "dc.description":
      "Professionele 3D websites en webdesign diensten in Nederland",
