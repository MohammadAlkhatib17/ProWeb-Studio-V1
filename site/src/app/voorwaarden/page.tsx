  ...
  return (
    <>
      ...
      <LegalContentLayout>
        ...
        <p>
          Deze voorwaarden zijn van toepassing op alle offertes en
          overeenkomsten van <strong>{name}</strong>.
        </p>
        ...
        <p>
          ...
          opdracht door beide partijen, of door aanvang van de werkzaamheden
          door {name}.
        </p>
        ...
        <p>
          ...
          Overschrijding van levertermijnen geeft geen recht op
          schadevergoeding, tenzij sprake is van opzet of grove schuld.
        </p>
        ...
        <ul>
          ...
          <li>
            <strong>Rente</strong>: Bij te late betaling wordt 1% rente per
            maand berekend over het openstaande bedrag.
          </li>
        </ul>
        ...
        <p>
          De aansprakelijkheid van {name} is beperkt tot het factuurbedrag van
          de betreffende opdracht. {name} is niet aansprakelijk voor indirecte
        ...
        <p>
          ...
          verstaan: ziekte, overheidsmaatregelen, stroomuitval, internetstoring
          en andere omstandigheden buiten onze controle.
        </p>
        ...
        >
          ...
          <ol>
            ...
            <li>
              <strong>Intellectuele eigendom</strong> – rechten op design, code
              en licenties.
            </li>
            <li>
              <strong>Aansprakelijkheid</strong> – beperkingen en
              uitzonderingen.
            </li>
            <li>
