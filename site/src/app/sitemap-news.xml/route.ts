...
export async function GET() {
  ...
  const newsEntries: NewsSitemapEntry[] = [
    // Example blog posts - replace with actual blog content when available
    {
      ...
      news: {
        ...
        keywords:
          "Core Web Vitals, website optimalisatie, performance, SEO, Google ranking",
      },
      lastModified: getLastModifiedDate(
        "docs/CORE_WEB_VITALS_OPTIMIZATION_GUIDE.md",
      ),
    },
    {
      ...
      news: {
        ...
        keywords:
          "3D websites, webdesign trends, Three.js, immersive experiences, web development",
      },
    ...
    },
    {
      ...
      news: {
        ...
        keywords:
          "SEO Nederland, lokale SEO, Nederlandse markt, zoekmachine optimalisatie",
      },
    ...
    },
    {
      ...
      news: {
        ...
        keywords:
          "website beveiliging, security headers, CSP, HTTPS, web security",
      },
      lastModified: getLastModifiedDate(
    ...
    },
    {
      ...
      news: {
        ...
        keywords:
          "Vercel optimalisatie, website performance, CDN, edge computing",
      },
    ...
    },
    {
      ...
      news: {
        ...
        keywords:
          "ProWeb Studio, nieuwe diensten, 3D websites, web development Nederland",
      },
    ...
    },
    {
      ...
      news: {
        ...
        keywords:
          "portfolio update, nieuwe projecten, case studies, web development",
      },
  ...
  const entriesToInclude =
    recentNewsEntries.length > 0 ? recentNewsEntries : newsEntries.slice(0, 5); // Include 5 most recent for demo
