    ...
    <>
      ...
      <LegalContentLayout>
        ...
        <p>
          ...
          (&quot;wij&quot;, &quot;ons&quot; of &quot;onze&quot;) uw
          persoonsgegevens verwerkt in overeenstemming met de Algemene
          Verordening Gegevensbescherming (AVG/GDPR) en toepasselijke
          Nederlandse wetgeving.
        </p>

        <h2>1. Verwerkingsverantwoordelijke</h2>
        <p>
          <strong>{name}</strong> is de verwerkingsverantwoordelijke. Voor
          vragen over dit beleid of uw rechten kunt u ons bereiken via{" "}
        ...
        <ul>
          <li>
            ...
            precontractuele maatregelen): om uw aanvraag te verwerken en met u
            te communiceren.
          </li>
          <li>
          ...
          <li>
            <strong>Verbetering en beveiliging</strong> (gerechtvaardigd
            belang): om prestaties, veiligheid en stabiliteit te verbeteren.
          </li>
          <li>
        ...
        <ul>
          <li>
            <strong>Contactaanvragen</strong>: maximaal 24 maanden na het
            laatste contactmoment, tenzij een zakelijke relatie ontstaat.
          </li>
          <li>
        ...
        <p>
          Wij delen geen persoonsgegevens met derden, tenzij noodzakelijk voor
          de dienstverlening (verwerkers) of wettelijk verplicht. Met verwerkers
        ...
        <p>
          Indien doorgifte buiten de Europese Economische Ruimte noodzakelijk
          is, zorgen wij voor passende waarborgen (art. 46 AVG), zoals
        ...
        <ul>
          ...
          <li>
            Recht van bezwaar tegen verwerking op basis van gerechtvaardigd
            belang of direct marketing.
          </li>
          <li>
        ...
        <p>
          ...
          binnen 30 dagen. U heeft ook het recht om een klacht in te dienen bij
        ...
        >
          ...
          <h2>Rechtsgrond</h2>
          <p>
            Toestemming, uitvoering van overeenkomst, gerechtvaardigd belang.
          </p>
          <h2>Bewaartermijnen</h2>
          <p>Niet langer dan noodzakelijk.</p>
          <h2>Delen met derden</h2>
          <p>
            Alleen met verwerkers die aan onze normen voldoen (hosting,
            analytics, e‑mail).
          </p>
