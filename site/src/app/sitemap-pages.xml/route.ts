/**
 * Segmented sitemap: Pages
 * 
 * Serves only static pages (home, about, contact, etc.)
 * Accessible at /sitemap-pages.xml
 */

import { generatePagesSegment } from '@/lib/sitemap-advanced';
