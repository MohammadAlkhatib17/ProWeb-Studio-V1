  ...
  const regions = [
    {
      ...
      description:
        "Website laten maken in Amsterdam voor startups, scale-ups en gevestigde bedrijven. Moderne webdesign voor de hoofdstad.",
      features: [
        "Startup-vriendelijk",
        "Snelle oplevering",
        "Internationale uitstraling",
        "Tech-savvy oplossingen",
      ],
      keywords: [
        "website laten maken Amsterdam",
        "webdesign Amsterdam",
        "startup website Amsterdam",
      ],
    ...
    },
    {
      ...
      description:
        "Professionele websites voor Rotterdam&apos;s zakelijke sector. Van haven-gerelateerde bedrijven tot moderne dienstverlening.",
      features: [
        "Zakelijke focus",
        "Haven & logistiek expertise",
        "B2B optimalisatie",
    ...
    },
    {
      ...
      province: "Zuid-Holland",
      description:
        "Website ontwikkeling voor Den Haag&apos;s overheid, juridische sector en internationale organisaties. Compliance en professionaliteit voorop.",
      features: [
        "Overheid-compliant",
        "Juridische sector",
    ...
    },
    {
      ...
      province: "Utrecht",
      description:
        "Centrale ligging, dynamische economie. Websites voor Utrecht&apos;s diverse bedrijfsleven, van tech tot traditionele sectoren.",
      features: [
        "Centrale locatie",
        "Diverse sectoren",
    ...
    },
    {
      ...
      description:
        "Tech-hub van Nederland. Websites voor Eindhoven&apos;s high-tech industrie, startups en innovatieve bedrijven.",
      features: [
        "High-tech focus",
        "Brainport regio",
        "Innovatie-gericht",
    ...
    },
    {
      ...
      province: "Noord-Brabant",
      description:
        "Sterke zakelijke gemeenschap in Tilburg. Websites voor industrie, logistiek en moderne dienstverlening.",
      features: [
      ...
      keywords: [
        "website bouwen Tilburg",
        "bedrijfswebsite Tilburg",
        "webdesign Noord-Brabant",
      ],
    ...
    },
    {
      ...
      province: "Groningen",
      description:
        "Noordelijke kwaliteit en innovatie. Websites voor Groningen&apos;s energie sector, universiteit en lokale bedrijven.",
      features: [
        "Energie sector",
        "Universitaire omgeving",
        "Noordelijke kwaliteit",
        "Duurzame focus",
      ],
      keywords: [
        "website laten maken Groningen",
        "webdesign Noord-Nederland",
        "energie website",
      ],
      population: "235k+ inwoners",
    ...
    },
    {
      ...
      province: "Flevoland",
      description:
        "Snelgroeiende stad met moderne bedrijven. Websites voor Almere&apos;s dynamische ondernemersklimaat.",
      features: [
        "Snelle groei",
        "Moderne bedrijven",
        "Jonge demografie",
      ...
      keywords: [
        "website ontwikkeling Almere",
        "moderne website Almere",
        "webdesign Flevoland",
      ],
  ...
  const provinces = [
    {
      name: "Randstad",
      description:
        "Het economische hart van Nederland. Websites voor bedrijven in de Randstad met focus op bereikbaarheid en schaalgroei.",
      cities: ["Amsterdam", "Rotterdam", "Den Haag", "Utrecht"],
      keywords: [
        "website laten maken Randstad",
        "webdesign Randstad",
        "zakelijke website",
      ],
    },
    {
      name: "Noord-Holland",
      description:
        "Van Amsterdam tot de Wadden. Diverse websites voor toerisme, tech, en traditionele Noord-Hollandse bedrijven.",
      cities: ["Amsterdam", "Haarlem", "Alkmaar", "Hoorn"],
      keywords: [
        "website Noord-Holland",
        "webdesign provincie",
        "lokale website",
      ],
    },
    {
      name: "Zuid-Holland",
      description:
        "Haven, overheid en zakelijke dienstverlening. Robuuste websites voor Zuid-Holland&apos;s diverse economie.",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg sm:text-xl text-slate-200 max-w-4xl mx-auto mb-8">
            Van Amsterdam tot Groningen, van Rotterdam tot Maastricht - wij
            bedienen Nederlandse ondernemers door het hele land. Lokale kennis,
            landelijke kwaliteit.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-slate-200">
                Begrip van lokale markt, cultuur en zakelijke gewoonten
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-slate-200">
                Zelfde tijdzone, directe bereikbaarheid, snelle reacties
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-slate-200">
                GDPR/AVG, BTW, Nederlandse wetgeving - alles geregeld
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-slate-200">
                Van video calls tot on-site meetings - wat u prefereert
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-slate-200 mb-8 max-w-2xl mx-auto">
            Ongeacht waar in Nederland uw bedrijf gevestigd is, wij helpen u met
            een professionele website die resultaat levert voor uw lokale of
            landelijke markt.
          </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Professionele website ontwikkeling voor bedrijven door heel Nederland. Van Amsterdam tot Groningen, lokale kennis met landelijke kwaliteit.",
            provider: {
              "@type": "Organization",
