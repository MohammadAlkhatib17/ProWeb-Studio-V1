...
export function PageLayout({ children, variant = 'standard', className }: PageLayoutProps) {
  ...
  return (
    <main className={designClasses(baseClasses, className)}>
      {children}
    </main>
  );
}
...
export function SectionLayout({ children, variant = 'content', className, id }: SectionLayoutProps) {
...
export function PageTitle({ children, className, as: Component = 'h1' }: TypographyProps) {
  return (
    <Component className={designClasses(designSystem.typography.pageTitle, className)}>
      {children}
    </Component>
  );
}
...
export function SectionTitle({ children, className, as: Component = 'h2' }: TypographyProps) {
  return (
    <Component className={designClasses(designSystem.typography.sectionTitle, className)}>
      {children}
    </Component>
  );
}

export function SubsectionTitle({ children, className, as: Component = 'h3' }: TypographyProps) {
  return (
    <Component className={designClasses(designSystem.typography.subsectionTitle, className)}>
      {children}
    </Component>
  );
}
...
export function CardTitle({ children, className, as: Component = 'h4' }: TypographyProps) {
  return (
    <Component className={designClasses(designSystem.typography.cardTitle, className)}>
      {children}
    </Component>
  );
}

export function BodyText({ children, className, variant = 'primary' }: TypographyProps & { variant?: 'primary' | 'secondary' }) {
  const variantClass = variant === 'primary' 
    ? designSystem.typography.bodyPrimary 
    : designSystem.typography.bodySecondary;
    
  return (
    <p className={designClasses(variantClass, className)}>
      {children}
    </p>
  );
}
...
export function GridLayout({ children, variant = 'features', className }: GridLayoutProps) {
  ...
  return (
    <div className={designClasses(getGridClasses(), className)}>
      {children}
    </div>
  );
}
...
export function CTASection({ 
  ...
  return (
    <SectionLayout variant="content" className={designClasses("text-center", className)}>
