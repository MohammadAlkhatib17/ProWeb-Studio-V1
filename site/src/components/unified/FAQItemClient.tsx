  ...
  return (
    ...
    >
      <summary className="flex items-start justify-between p-4 md:p-6 cursor-pointer list-none">
        ...
        <div
          className={`flex-shrink-0 w-8 h-8 mt-1 rounded-full bg-cyan-400/10 flex items-center justify-center transition-all duration-300 ease-in-out group-hover:bg-cyan-400/20 border border-cyan-400/20 ${isOpen ? "rotate-180" : ""}`}
        >
          <svg
            className="w-4 h-4 text-cyan-300 transition-all duration-300 ease-in-out"
            viewBox="0 0 24 24"
            fill="none"
            stroke="currentColor"
            strokeWidth="2"
