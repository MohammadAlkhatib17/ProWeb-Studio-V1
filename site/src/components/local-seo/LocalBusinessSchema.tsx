...
export default function LocalBusinessSchema({ city, customData }: LocalBusinessSchemaProps) {
  ...
  const organizationSchema = {
    ...
    "description": "ProWeb Studio ontwikkelt snelle, veilige en schaalbare 3D-websites die scoren in Google en converteren.",
    "telephone": businessData.phone,
    "email": businessData.email,
    "address": {
      "@type": "PostalAddress",
      ...
      "itemListElement": [
        {
          ...
          "itemOffered": {
            ...
            "description": "Volledig op maat gemaakte websites met 3D elementen en moderne technologieën"
          },
          "priceCurrency": "EUR",
          "eligibleRegion": {
            "@type": "Country",
        ...
        },
        {
          ...
          "itemOffered": {
            ...
            "description": "Webshops met Nederlandse betaalmethoden en volledige integratie"
          },
          "priceCurrency": "EUR",
          "eligibleRegion": {
            "@type": "Country", 
