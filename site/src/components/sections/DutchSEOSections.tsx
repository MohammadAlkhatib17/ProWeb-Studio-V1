...
export function DutchSEOHeroSection({
  cityName,
  className = "",
}: DutchSEOHomeSectionProps) {
      ...
      >
        <article className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-lg sm:text-xl lg:text-2xl text-slate-300 mb-8 max-w-4xl mx-auto leading-relaxed">
            Van <strong>website laten maken</strong> tot complete{" "}
            <strong>digitale transformatie</strong> - ProWeb Studio is uw
            betrouwbare <strong>Nederlandse webdesign partner</strong>. Wij
            bouwen <strong>professionele websites</strong> en{" "}
            <strong>webshops</strong> die converteren en groeien met uw bedrijf.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="bg-cosmic-800/40 p-6 rounded-xl border border-cosmic-700/60 hover:border-cosmic-600/80 transition-all duration-300">
              <SemanticHeading
                level={3}
                className="text-xl font-semibold mb-3 text-cyan-300"
              >
                🏆 Nederlandse Kwaliteit
              </SemanticHeading>
              <p className="text-slate-300 text-sm">
                <strong>KvK geregistreerd</strong> webdesign bureau met lokale
                ondersteuning en <strong>Nederlandse hosting</strong> voor
                optimale prestaties.
              </p>
            </div>
            ...
            <div className="bg-cosmic-800/40 p-6 rounded-xl border border-cosmic-700/60 hover:border-cosmic-600/80 transition-all duration-300">
              ...
              <p className="text-slate-300 text-sm">
                ...
                <strong>iDEAL betalingen</strong> en{" "}
                <strong>AVG compliance</strong> standaard inbegrepen.
              </p>
            </div>
            ...
            <div className="bg-cosmic-800/40 p-6 rounded-xl border border-cosmic-700/60 hover:border-cosmic-600/80 transition-all duration-300">
              ...
              <p className="text-slate-300 text-sm">
                Gespecialiseerd in <strong>MKB websites</strong>,{" "}
                <strong>ZZP-ers</strong> en
                <strong>startups</strong> met transparante prijzen en snelle
                oplevering.
              </p>
            </div>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <header className="text-center mb-16">
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto">
            Van eenvoudige <strong>bedrijfswebsites</strong> tot complexe{" "}
            <strong>webshops</strong> en innovatieve{" "}
            <strong>3D website ervaringen</strong> - wij realiseren uw digitale
            ambities.
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <article className="bg-cosmic-800/40 p-8 rounded-2xl border border-cosmic-700/60 hover:border-cosmic-600/80 transition-all duration-300 hover:shadow-2xl hover:shadow-cyan-500/10">
            ...
            <p className="text-slate-300 mb-6 leading-relaxed">
              <strong>Professionele websites</strong> die perfect aansluiten bij
              uw bedrijf. Responsive design,{" "}
              <strong>SEO geoptimaliseerd</strong> en{" "}
              <strong>Nederlandse hosting</strong>
          ...
          <article className="bg-cosmic-800/40 p-8 rounded-2xl border border-cosmic-700/60 hover:border-cosmic-600/80 transition-all duration-300 hover:shadow-2xl hover:shadow-cyan-500/10">
            ...
            <p className="text-slate-300 mb-6 leading-relaxed">
              Complete <strong>e-commerce oplossingen</strong> met{" "}
              <strong>iDEAL integratie</strong>, voorraadbeheeer en koppelingen
              met Nederlandse systemen. Perfect voor{" "}
              <strong>MKB ondernemers</strong>.
            </p>
            <div className="space-y-2 text-sm text-slate-400 mb-6">
              <div className="flex items-center">
                <span className="w-2 h-2 bg-cyan-400 rounded-full mr-3"></span>
          ...
          <article className="bg-cosmic-800/40 p-8 rounded-2xl border border-cosmic-700/60 hover:border-cosmic-600/80 transition-all duration-300 hover:shadow-2xl hover:shadow-cyan-500/10">
            ...
            <p className="text-slate-300 mb-6 leading-relaxed">
              <strong>Lokale SEO</strong> en{" "}
              <strong>nationale vindbaarheid</strong> in Google. Nederlandse
              zoekwoorden, <strong>Google My Business</strong> optimalisatie en
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          {DUTCH_TRUST_SIGNALS.certifications.map((cert, index) => (
            <div
              key={index}
              className="text-center p-6 bg-cosmic-800/40 rounded-xl border border-cosmic-700/60"
            >
              <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-cyan-500/20 to-magenta-500/20 rounded-full flex items-center justify-center text-2xl">
                {cert.name === "KvK Registratie"
                  ? "🏢"
                  : cert.name === "AVG Compliant"
                    ? "🔒"
                    : "🇳🇱"}
              </div>
              <SemanticHeading
                level={3}
                className="text-lg font-semibold mb-2 text-cyan-300"
              >
                {cert.name}
              </SemanticHeading>
              <p className="text-slate-300 text-sm">
        ...
        <div className="bg-cosmic-800/40 p-8 rounded-2xl border border-cosmic-700/60">
          ...
          <p className="text-center text-slate-300 mt-4">
            Wij accepteren alle gangbare Nederlandse betaalmethoden voor uw
            gemak
          </p>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <header className="text-center mb-16">
          ...
          <p className="text-xl text-slate-300">
            Ontdek waarom meer dan 500 Nederlandse bedrijven hun website door
            ons lieten maken
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {DUTCH_TRUST_SIGNALS.testimonials.map((testimonial, index) => (
            <article
              key={index}
              className="bg-cosmic-800/40 p-8 rounded-2xl border border-cosmic-700/60 hover:border-cosmic-600/80 transition-all duration-300"
            >
