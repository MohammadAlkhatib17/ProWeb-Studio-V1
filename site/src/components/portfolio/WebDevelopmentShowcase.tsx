        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-cosmic-200 mb-8 leading-relaxed">
              Wij creëren interactieve websites die niet alleen mooi zijn, maar
              ook presteren. Met Three.js en React brengen wij jullie digitale
              visie tot leven met cutting-edge 3D technologie.
            </p>
