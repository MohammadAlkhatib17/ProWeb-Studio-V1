...
const caseStudies: CaseStudy[] = [
  {
    ...
    description:
      "Complete rebranding en e-commerce platform voor een gevestigde Nederlandse fashion brand.",
    challenge:
      "Verouderde website met lage conversie, geen mobiele optimalisatie en zwakke brand identity in een competitieve markt.",
    solution:
      "Modern 3D e-commerce platform met interactieve product showcase, geoptimaliseerd voor Nederlandse consumers en mobile-first design.",
    results: [
      {
        metric: "Conversie Verbetering",
        value: "+340%",
        description: "Van 1.2% naar 5.3% conversie ratio",
      },
      {
        metric: "Mobiel Traffic",
        value: "+280%",
        description: "Significante toename mobile bezoekers",
      },
      {
        metric: "Gemiddelde Bestelling",
        value: "+67%",
        description: "Hogere AOV door betere UX",
      },
      {
        metric: "Pagina Laadtijd",
        value: "2.1s",
        description: "Optimale performance op alle devices",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Complexe data visualisatie platform met real-time analytics voor Nederlandse tech bedrijven.",
    challenge:
      "Complexe data moest intuïtief worden gepresenteerd voor niet-technische gebruikers, met real-time updates en multi-tenant architectuur.",
    solution:
      "Interactive 3D dashboard met WebGL visualisaties, real-time data streams en gebruiksvriendelijke Nederlandse interface.",
    results: [
      {
        metric: "Gebruikers Retentie",
        value: "+89%",
        description: "Verhoogde user engagement",
      },
      {
        metric: "Klanttevredenheid",
        value: "9.2/10",
        description: "Hoge NPS score",
      },
      {
        metric: "Data Processing",
        value: "99.9%",
        description: "Uptime en betrouwbaarheid",
      },
      {
        metric: "Load Time",
        value: "1.8s",
        description: "Snelle data visualisatie",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Progressive Web App met locatie-based services en real-time bestellingen voor restaurant keten.",
    challenge:
      "Integratie van 25+ locaties, real-time voorraad tracking, en naadloze mobile ervaring voor Nederlandse foodies.",
    solution:
      "PWA met geolocation, push notifications, offline functionaliteit en integration met POS systemen.",
    results: [
      {
        metric: "App Adoptie",
        value: "+156%",
        description: "Downloads en actieve gebruikers",
      },
      {
        metric: "Online Bestellingen",
        value: "+243%",
        description: "Toename digital orders",
      },
      {
        metric: "Customer Satisfaction",
        value: "4.8/5",
        description: "App store ratings",
      },
      {
        metric: "Repeat Orders",
        value: "+78%",
        description: "Verhoogde klantloyaliteit",
      },
    ],
    technologies: [
      "PWA",
...
export default function CaseStudies() {
  ...
  const currentCase =
    caseStudies.find((study) => study.id === selectedCase) || caseStudies[0];
      ...
      <div className="container mx-auto px-safe">
        ...
        >
          ...
          <p className="text-xl text-cosmic-200 max-w-3xl mx-auto">
            Ontdek hoe wij Nederlandse bedrijven hebben geholpen hun digitale
            doelen te bereiken met innovatieve oplossingen en meetbare
            resultaten.
          </p>
        </motion.div>
            ...
            <div className="bg-gradient-to-r from-stellar-900/50 to-cosmic-900/50 rounded-xl p-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div>
                    <div className="font-semibold text-stellar-400">
                      {currentCase.testimonial.author}
                    </div>
                    <div className="text-sm text-cosmic-300">
                      {currentCase.testimonial.position} bij{" "}
          ...
          <div>
            ...
            <div className="bg-cosmic-800/30 rounded-lg p-8 text-center">
              <div className="w-full h-64 bg-gradient-to-br from-cosmic-700 to-stellar-800 rounded-lg flex items-center justify-center mb-4">
                <svg
                  className="w-16 h-16 text-cosmic-400"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
