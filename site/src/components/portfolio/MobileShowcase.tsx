...
export default function MobileShowcase() {
  return (
    <div className="py-16 lg:py-24 relative overflow-hidden">
      {/* Harmonious Background Gradient - Matching Section 1 */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
              {[
                { icon: Smartphone, title: 'Mobile-First', desc: 'Ontwerp begint op mobiel' },
                { icon: Check, title: 'Touch-Friendly', desc: 'Optimaal voor aanraking' },
                { icon: Globe, title: 'Cross-Platform', desc: 'Werkt op alle browsers' },
                { icon: Laptop, title: 'Progressive Web App', desc: 'App-achtige ervaring' }
              ].map((item, i) => (
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                href="/contact"
                variant="primary"
                className="!bg-gradient-to-r !from-blue-600 !to-cyan-600 !text-white !shadow-lg hover:!shadow-cyan-500/20 border-node hover:!scale-105"
              >
