...
function ShoppingCart() {
  ...
  useFrame((state) => {
    if (cartRef.current) {
      cartRef.current.rotation.y = Math.sin(state.clock.elapsedTime * 0.5) * 0.3;
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-cosmic-200 mb-8 leading-relaxed">
              Van kleine webshops tot grootschalige marketplaces - wij bouwen e-commerce oplossingen 
              die niet alleen verkopen, maar ook jullie klanten verrassen met een unieke shopping ervaring.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-white mb-1">Hoge Conversie</h3>
                  <p className="text-sm text-cosmic-300">Geoptimaliseerd voor verkoop</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-white mb-1">Veilige Betalingen</h3>
                  <p className="text-sm text-cosmic-300">SSL en payment gateway</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-white mb-1">Inventory Management</h3>
                  <p className="text-sm text-cosmic-300">Automatische voorraad tracking</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-white mb-1">Mobile Optimized</h3>
                  <p className="text-sm text-cosmic-300">Perfect op mobiele apparaten</p>
                </div>
              </div>
            </div>

            <div className="bg-cosmic-800/50 rounded-lg p-6 mb-8">
              <h3 className="text-xl font-semibold text-white mb-4">Case Study: Nederlandse Fashion Brand</h3>
              <div className="grid grid-cols-3 gap-4 text-center">
                <div>
                  <div className="text-2xl font-bold text-stellar-400">+340%</div>
                  <div className="text-sm text-cosmic-300">Conversie Verbetering</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-stellar-400">2.1s</div>
                  <div className="text-sm text-cosmic-300">Laadtijd</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-stellar-400">€2.4M</div>
