        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-cosmic-200 mb-8 leading-relaxed">
              ...
              identities die resoneren met de Nederlandse markt en jullie
              doelgroep aanspreken. Authentiek, herkenbaar en tijdloos.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-cosmic-300">
                    Complete huisstijl handleiding
                  </p>
                </div>
              </div>
            </div>
