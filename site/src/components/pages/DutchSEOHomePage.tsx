...
} from "@/components/sections/DutchSEOSections";
...
export function generateDutchSEOMetadata(
  cityName?: string,
  serviceFocus?: string,
): Metadata {
  const baseTitle =
    "Website Laten Maken Nederland | Webdesign & Webshop Ontwikkeling";
...
export default function DutchSEOHomePage({
  cityName,
  serviceFocus,
}: DutchSEOHomePageProps) {
        ...
        >
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
              ...
              Nederlandse webdesign experts staan klaar om uw online ambities
              waar te maken.
            </p>
