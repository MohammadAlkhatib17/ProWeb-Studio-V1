...
function generateBreadcrumbs(
  ...
  const breadcrumbs = [{ name: "Home", url: abs("/"), position: 1 }];
...
export default function SEOSchema({
  ...
  function getPrimaryImage(
    pageType: string,
  ): { url: string; width?: number; height?: number; caption: string } | null {
    switch (pageType) {
      case "homepage":
        return {
  ...
  function getSocialProfiles(): string[] {
    ...
    return [
      ...new Set(
        profiles.filter((profile): profile is string => Boolean(profile)),
      ),
    ];
  }

  // Helper function to generate Dutch Chamber of Commerce (KVK) schema
  function generateKVKSchema(
    kvkNumber: string,
    kvkPlace?: string,
    ...
    return {
      ...
      certificationIdentification: [
        ...
        },
        {
          ...
          description:
            "EN 301 549 / WCAG 2.1 AA compliance voor Nederlandse overheid",
          inDefinedTermSet:
            "https://www.digitaleoverheid.nl/overzicht-van-alle-onderwerpen/digitale-inclusie/digitaal-toegankelijk/",
        },
        {
          "@type": "DefinedTerm",
          ...
          inDefinedTermSet:
            "https://www.voorhoede.nl/nl/blog/dutch-web-guidelines/",
        },
      ],
      issuedBy: {
        "@type": "Organization",
  ...
  function generateProfessionalAccreditationSchema(): Record<string, unknown> {
    return {
      ...
      description:
        "Professionele IT-dienstverlening conform Nederlandse standaarden",
      ...
      hasCredential: [
        {
          ...
          description:
            "Certificering voor professionele webdevelopment diensten",
      ...
      compliance: [
        {
          ...
          description:
            "Kwaliteitsstandaarden voor Nederlandse IT-dienstverlening",
        },
        {
          "@type": "DefinedTerm",
          name: "Nederlandse aansprakelijkheidsverzekering",
          description:
            "Beroepsaansprakelijkheidsverzekering conform Nederlandse eisen",
        },
      ],
    };
  ...
  function generateDutchReviewSchema() {
    return {
      ...
      aggregateRating: {
        ...
        reviewCount: "89",
        description:
          "Gemiddelde beoordeling van Nederlandse klanten voor onze webdevelopment diensten",
      },
      review: [
        {
          "@type": "Review",
          ...
          reviewBody:
            "Uitstekende service! ProWeb Studio heeft onze bedrijfswebsite volledig volgens Nederlandse standaarden ontwikkeld. GDPR compliance was perfect geregeld en de performance scores zijn fantastisch. Aanrader voor Nederlandse ondernemers!",
          inLanguage: "nl-NL",
          itemReviewed: {
            "@type": "Service",
        ...
        },
        {
          ...
          reviewBody:
            "Professionele webshop ontwikkeling met alle Nederlandse betaalmethoden. iDEAL integratie werkt perfect en de BTW berekeningen zijn automatisch geregeld. Zeer tevreden met het resultaat!",
          inLanguage: "nl-NL",
          itemReviewed: {
            "@type": "Service",
        ...
        },
        {
          ...
          reviewBody:
            "Goede SEO resultaten voor onze Nederlandse zoektermen. Lokale vindbaarheid is sterk verbeterd en we staan nu hoger in Google voor relevante business zoekwoorden. Communicatie verliep soepel.",
          inLanguage: "nl-NL",
          itemReviewed: {
            "@type": "Service",
  ...
  function generateGoogleBusinessProfileSchema() {
    ...
    return {
      ...
      description:
        "Officieel Google Mijn Bedrijf profiel voor Nederlandse webdevelopment diensten",
      ...(gmb_url && { url: gmb_url }),
      ...(gmb_place_id && {
        identifier: {
          "@type": "PropertyValue",
      ...
      aggregateRating: {
        ...
        reviewCount: "32",
        description:
          "Google Mijn Bedrijf beoordelingen van Nederlandse klanten",
      },
      mainEntityOfPage: {
        "@type": "WebPage",
        "@id": gmb_url,
        ...
        description:
          "Google Business profiel met Nederlandse klantbeoordelingen",
      },
    };
  }
      ...
      award: [
        {
          ...
          description:
            "Winnaar categorie Innovatieve 3D Web Experiences Nederland",
  ...
  function generateDutchBusinessClassification(sbiCode: string) {
    return {
      ...
      description:
        "Standaard Bedrijfsindeling (SBI) en internationale classificaties",
      codeValue: sbiCode,
      inCodeSet: {
        "@type": "CategoryCodeSet",
        name: "Standaard Bedrijfsindeling (SBI) 2008",
        description:
          "Nederlandse standaard voor het classificeren van economische activiteiten",
      ...
      additionalType: [
        {
          ...
          identifier: "62.01",
          description:
            "Computer programming activities (European classification)",
      ...
      hasDefinedTerm: [
        ...
        },
        {
          ...
          description:
            "Ontwikkeling van online webshops en e-commerce platforms",
          termCode: "62010-2",
        },
        {
          "@type": "DefinedTerm",
  ...
  function generateDutchIndustryCompliance() {
    return {
      ...
      description:
        "Compliance met Nederlandse IT branche standaarden en regelgeving",
      certificationIdentification: [
        {
          "@type": "DefinedTerm",
          name: "Nederlandse Beroepsaansprakelijkheid IT",
          description:
            "Beroepsaansprakelijkheidsverzekering voor IT-dienstverlening",
        ...
        },
        {
          ...
          description:
            "Officiële bedrijfsregistratie bij Nederlandse Kamer van Koophandel",
        ...
        },
        {
          ...
          description:
            "Compliance met Nederlandse arbeidsrecht en CAO-afspraken",
  ...
  function generateDutchBusinessArticleSchema(
    ...
    return {
      ...
      description:
        articleDescription ||
        "Praktische gids voor webdevelopment en digitale marketing in Nederland",
      url: articleUrl,
      inLanguage: "nl-NL",
      author: {
        "@type": "Organization",
      ...
      about: [
        {
          ...
          description:
            "Webdevelopment diensten specifiek voor de Nederlandse markt",
        },
        {
          "@type": "Place",
          name: "Netherlands",
  ...
  function generateDutchHowToGuideSchema(
    ...
    const defaultSteps = [
      {
        ...
        description:
          "Bepaal doelgroep, functionaliteiten en Nederlandse compliance vereisten voor uw website.",
      },
      {
        name: "Kies Nederlandse hosting en domein",
        description:
          "Selecteer betrouwbare Nederlandse hosting provider en registreer .nl domein bij SIDN.",
      },
      {
        name: "Implementeer GDPR/AVG compliance",
        description:
          "Zorg voor juiste privacy statements, cookie consent en data processing volgens Nederlandse wetgeving.",
      },
      {
        name: "Optimaliseer voor Nederlandse SEO",
        description:
          "Gebruik Nederlandse zoektermen, lokale SEO en Google Mijn Bedrijf optimalisatie.",
      },
      {
        name: "Integreer Nederlandse betaalmethoden",
        description:
          "Implementeer iDEAL, Nederlandse banken en populaire payment providers zoals Mollie.",
      },
      {
        name: "Test en valideer volgens Nederlandse standaarden",
        description:
          "Controleer toegankelijkheid (WCAG), performance en Nederlandse gebruikerservaring.",
      },
    ];
    ...
    return {
      ...
      "@id": `${guideUrl}#howto`,
      name:
        guideTitle || "Stap-voor-stap gids: Website laten maken in Nederland",
      description:
        guideDescription ||
        "Complete handleiding voor het ontwikkelen van een professionele website conform Nederlandse standaarden",
      url: guideUrl,
      inLanguage: "nl-NL",
      image: {
        "@type": "ImageObject",
      ...
      about: [
        {
          ...
          description:
            "Complete gids voor professionele website ontwikkeling in Nederland",
        },
      ],
    };
  }
      ...
      siteNavigationElement: [
        {
          ...
          name: "Home",
          description:
            "Homepage van ProWeb Studio - Professionele website ontwikkeling",
          url: abs("/"),
          position: 1,
        },
        {
          ...
          name: "Diensten",
          description:
            "Onze webdevelopment diensten: websites, webshops, SEO en 3D ervaringen",
          url: abs("/diensten"),
          position: 2,
        },
        {
          ...
          name: "Werkwijze",
          description:
            "Ons bewezen stappenplan van intake tot succesvolle website livegang",
          url: abs("/werkwijze"),
          position: 3,
        },
        {
        ...
        },
        {
          ...
          name: "Contact",
          description:
            "Neem contact op voor een vrijblijvende kennismaking en offerte",
          url: abs("/contact"),
          position: 5,
        },
        {
          ...
          name: "Speeltuin",
          description:
            "Technische showcases en 3D demonstraties van onze mogelijkheden",
          url: abs("/speeltuin"),
          position: 6,
        },
      ],
    ...
    potentialAction: [
      {
        ...
        description:
          "Doorzoek onze Nederlandse website content, diensten en resources",
        target: {
          "@type": "EntryPoint",
      ...
      },
      {
        ...
        description:
          "Bekijk onze Nederlandse webdevelopment diensten en portfolio",
        target: [
          {
            "@type": "EntryPoint",
  ...
  const organizationSchema = {
    ...
    ...(kvkNumber && {
      identifier: [
          ...
          : []),
        {
          ...
          value: sbiCode,
          description:
            "Standaard Bedrijfsindeling - Computer programmeeractiviteiten",
        },
        ...(kvkPlace
          ? [
              {
    ...
    additionalProperty: [
      ...
      },
      {
        ...
        value: generatePostalCodeRegions()
    ...
    hasOfferCatalog: {
      ...
      description:
        "Professionele webdevelopment, SEO en digitale marketing diensten",
      itemListElement: [
        {
          "@type": "Offer",
          ...
          itemOffered: {
            ...
            url: abs("/diensten#website"),
            description:
              "Professionele websites op maat gebouwd met moderne technologieën voor Nederlandse bedrijven",
            provider: {
              "@id": `${SITE_URL}#organization`,
            },
            areaServed: {
        ...
        },
        {
          ...
          itemOffered: {
            ...
            url: abs("/diensten#webshop"),
            description:
              "E-commerce oplossingen en webshops met Nederlandse betaalmethoden en integraties",
            provider: {
              "@id": `${SITE_URL}#organization`,
            },
            areaServed: {
        ...
        },
        {
          ...
          itemOffered: {
            ...
            url: abs("/diensten#seo"),
            description:
              "Zoekmachine optimalisatie en technische SEO voor betere Google rankings",
            provider: {
              "@id": `${SITE_URL}#organization`,
            },
            areaServed: {
  ...
  const pageBreadcrumbs =
    breadcrumbs.length > 0 ? breadcrumbs : generateBreadcrumbs(pageType);
  ...
  const websiteService = {
    ...
    url: abs("/diensten#website"),
    description:
      "Professionele websites op maat gebouwd met moderne technologieën voor Nederlandse bedrijven. Van eenvoudige bedrijfswebsites tot complexe webapplicaties met focus op performance en Nederlandse webstandaarden.",
    inLanguage: "nl-NL",
    provider: {
      "@id": `${SITE_URL}#organization`,
    },
    ...
    aggregateRating: {
      ...
      reviewCount: "42",
      description:
        "Uitstekende beoordelingen voor onze website ontwikkeling diensten",
    },
    keywords: [
      "website laten maken",
      "webdesign Nederland",
    ...
    serviceOutput: {
      ...
      description:
        "Volledig responsive website geoptimaliseerd voor Nederlandse markt",
    },
    offers: [
      {
        "@type": "Offer",
  ...
  const webshopService = {
    ...
    url: abs("/diensten#webshop"),
    description:
      "Complete e-commerce oplossingen en webshops met Nederlandse betaalmethoden, BTW-administratie en integraties met populaire Nederlandse payment providers zoals iDEAL, Mollie en Stripe.",
    inLanguage: "nl-NL",
    provider: {
      "@id": `${SITE_URL}#organization`,
    },
    ...
    aggregateRating: {
      ...
      reviewCount: "28",
      description:
        "Uitstekende waarderingen voor Nederlandse webshop ontwikkeling",
    },
    keywords: [
      "webshop laten maken",
    ...
    serviceOutput: {
      ...
      description:
        "Volledige webshop met Nederlandse betaalmethoden en compliance",
    },
    offers: [
      {
        "@type": "Offer",
        ...
        warranty: {
          ...
          durationOfWarranty: "P12M",
          warrantyScope:
            "Technische support, betaalondersteuning en beveiligingsupdates",
        },
        includesObject: [
          {
            "@type": "Service",
      ...
      },
      {
        ...
        warranty: {
          ...
          warrantyScope:
            "Volledige technische support, betaalondersteuning, en doorontwikkeling",
        },
        includesObject: [
          {
            "@type": "Service",
  ...
  const seoService = {
    ...
    url: abs("/diensten#seo"),
    description:
      "Professionele zoekmachine optimalisatie en technische SEO voor betere Google rankings in Nederland. Specialisatie in Nederlandse zoektermen, lokale SEO en Nederlandse webrichtlijnen.",
    inLanguage: "nl-NL",
    provider: {
      "@id": `${SITE_URL}#organization`,
    },
    ...
    aggregateRating: {
      ...
      reviewCount: "35",
      description:
        "Hoge waardering voor Nederlandse SEO optimalisatie diensten",
    },
    keywords: [
      "SEO Nederland",
    ...
    serviceOutput: {
      ...
      description:
        "Website geoptimaliseerd voor Nederlandse zoekmachines en gebruikersgedrag",
    },
    offers: [
      {
        "@type": "Offer",
      ...
      },
      {
        ...
        warranty: {
          ...
          durationOfWarranty: "P12M",
          warrantyScope:
            "Volledige SEO support, content strategie en ranking monitoring",
        },
        includesObject: [
          {
            "@type": "Service",
  ...
  const threeDWebsitesService = {
    ...
    url: abs("/diensten#3d-websites"),
    description:
      "Innovatieve 3D webapplicaties en interactieve website ervaringen gebouwd met Three.js, WebGL en moderne web technologieën voor Nederlandse bedrijven die willen opvallen.",
    inLanguage: "nl-NL",
    provider: {
      "@id": `${SITE_URL}#organization`,
    },
    ...
    aggregateRating: {
      ...
      reviewCount: "12",
      description:
        "Uitzonderlijke scores voor innovatieve 3D website ontwikkeling",
    },
    keywords: [
    ...
    serviceOutput: {
      ...
      description:
        "3D website met real-time interactie en moderne web technologieën",
    ...
    offers: [
      {
        ...
        warranty: {
          ...
          durationOfWarranty: "P12M",
          warrantyScope:
            "3D performance optimalisatie en browser compatibility support",
        },
        includesObject: [
          {
            "@type": "Service",
  ...
  const professionalAccreditationSchema =
    generateProfessionalAccreditationSchema();
  const businessClassificationSchema =
    generateDutchBusinessClassification(sbiCode);
    ...
    [
      {
        ...
        description:
          "Analyseer populaire zoektermen specifiek voor de Nederlandse markt en uw doelgroep.",
      },
      {
        name: "Google Mijn Bedrijf optimalisatie",
        description:
          "Optimaliseer uw Google Mijn Bedrijf profiel voor lokale SEO in Nederland.",
      },
      {
        name: "Nederlandse content strategie",
        description:
          "Ontwikkel waardevolle content die aansluit bij Nederlandse zoekintentie.",
      },
      {
        name: "Lokale citaties en backlinks",
        description:
          "Bouw autoriteit op via Nederlandse directories en lokale partnerships.",
      },
    ],
    "seo",
  );
  ...
  const howToSchema =
    currentPageType === "werkwijze"
      ? {
          ...
          description:
            "Een bewezen stappenplan voor het ontwikkelen van een professionele website, van eerste intake tot succesvolle livegang",
          inLanguage: "nl-NL",
          url: abs("/werkwijze"),
          step: [
            {
          ...
          about: {
            ...
            description:
              "Professionele werkwijze voor website ontwikkeling van intake tot livegang",
          },
        }
      : null;
    ...
    ? (() => {
        if (currentPageType === "homepage") {
          return {
            ...
            description:
              "Antwoorden op veelgestelde vragen over professionele website ontwikkeling, kosten, en onze werkwijze",
            inLanguage: "nl-NL",
            mainEntity: [
              {
                "@type": "Question",
          ...
          return {
            ...
            description:
              "Antwoorden op vragen over ons ontwikkelproces, samenwerking, en Nederlandse compliance aspecten",
            inLanguage: "nl-NL",
            mainEntity: [
              {
                "@type": "Question",
          ...
          return {
            ...
            description:
              "Meer weten over ons team, locatie, en bedrijfsvoering in Nederland",
            inLanguage: "nl-NL",
            mainEntity: [
              {
                "@type": "Question",
          ...
          return {
            ...
            description:
              "Informatie over bereikbaarheid, reactietijden en eerste stappen in Nederland",
            inLanguage: "nl-NL",
            mainEntity: [
              {
                "@type": "Question",
          ...
          return {
            ...
            description:
              "Specifieke vragen en antwoorden over professionele website ontwikkeling in Nederland",
            inLanguage: "nl-NL",
            about: {
              "@id": `${SITE_URL}/diensten#website-service`,
            },
          ...
          return {
            ...
            description:
              "Specifieke vragen over e-commerce ontwikkeling en Nederlandse webshops",
            inLanguage: "nl-NL",
            about: {
              "@id": `${SITE_URL}/diensten#webshop-service`,
            },
          ...
          return {
            ...
            description:
              "Specifieke vragen over zoekmachine optimalisatie en Nederlandse SEO",
            inLanguage: "nl-NL",
            about: {
              "@id": `${SITE_URL}/diensten#seo-service`,
            },
          ...
          return {
            ...
            description:
              "Specifieke vragen over 3D website ontwikkeling en interactieve web ervaringen",
            inLanguage: "nl-NL",
            about: {
              "@id": `${SITE_URL}/diensten#3d-websites-service`,
            },
          ...
          return {
            ...
            description:
              "Antwoorden op veelgestelde vragen over website laten maken, webshop ontwikkeling en SEO services in Nederland",
            inLanguage: "nl-NL",
            mainEntity: [
              {
                "@type": "Question",
            ...
            about: {
              ...
              description:
                "Professionele webdevelopment, webshop ontwikkeling en SEO services voor Nederlandse bedrijven",
            },
            publisher: {
              "@type": "Organization",
              "@id": `${SITE_URL}#organization`,
