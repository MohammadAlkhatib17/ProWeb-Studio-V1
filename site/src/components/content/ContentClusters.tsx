        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <header className="text-center mb-16">
            ...
            <p className="text-xl text-slate-300 max-w-4xl mx-auto leading-relaxed">
              Van de eerste ideeën tot een succesvolle online aanwezigheid -
              ontdek alle aspecten van
              <strong> website laten maken</strong> in Nederland. Professioneel
              advies van Nederlandse
            ...
            {cluster.supportingTopics.map((topic, index) => {
              ...
              const descriptions = {
                "kosten-website-laten-maken":
                  "Transparant overzicht van website kosten, prijzen en investeringen voor Nederlandse bedrijven.",
                "website-laten-maken-proces":
                  "Stap-voor-stap uitleg van ons bewezen ontwikkelproces van concept tot live website.",
                "responsive-website-ontwikkeling":
                  "Mobiel-vriendelijke websites die perfect werken op alle apparaten en schermformaten.",
                "moderne-website-trends-2025":
                  "Nieuwste webdesign trends, technologieën en best practices voor moderne websites.",
                "website-onderhoud-en-beheer":
                  "Doorlopend onderhoud, updates en technische support voor uw website.",
              };

              return (
                <article
                  key={index}
                  className="bg-cosmic-800/40 p-8 rounded-2xl border border-cosmic-700/60 hover:border-cosmic-600/80 transition-all duration-300 hover:shadow-2xl hover:shadow-cyan-500/10 group"
                >
                  ...
                  <SemanticHeading
                    level={3}
                    className="text-xl font-bold mb-4 text-cyan-300 group-hover:text-cyan-400 transition-colors duration-300"
                  >
                    {topic}
                  </SemanticHeading>

                  <p className="text-slate-300 mb-6 leading-relaxed text-sm">
                    {descriptions[topicSlug as keyof typeof descriptions] ||
                      `Ontdek alles over ${topic.toLowerCase()} en hoe dit bijdraagt aan uw online succes.`}
                  </p>
          ...
          <div className="bg-cosmic-800/40 p-8 rounded-2xl border border-cosmic-700/60 text-center">
            ...
            <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
              Start vandaag nog met uw professionele website project. Onze
              Nederlandse webdesign experts helpen u van concept tot succesvolle
              online aanwezigheid.
            </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-cosmic-800/20 p-8 rounded-2xl border border-cosmic-700/40">
                  ...
                  <p className="text-slate-300 mb-4 text-sm">
                    Ontdek wat Nederlandse webdesign uniek maakt en waarom
                    lokale expertise belangrijk is.
                  </p>
                  <ul className="space-y-2 mb-6">
                    <li>
                      <Link
                        href="/gids/nederlandse-webdesign-trends"
                        className="text-cyan-300 hover:text-cyan-400 text-sm transition-colors duration-200"
                      >
                    ...
                    <li>
                      <Link
                        href="/gids/lokale-webdesign-expertise"
                        className="text-cyan-300 hover:text-cyan-400 text-sm transition-colors duration-200"
                      >
                    ...
                    <li>
                      <Link
                        href="/gids/webdesign-voor-mkb-bedrijven"
                        className="text-cyan-300 hover:text-cyan-400 text-sm transition-colors duration-200"
                      >
                ...
                <div className="bg-cosmic-800/20 p-8 rounded-2xl border border-cosmic-700/40">
                  ...
                  <p className="text-slate-300 mb-4 text-sm">
                    Verbeter uw lokale vindbaarheid en trek meer Nederlandse
                    klanten aan.
                  </p>
                  <ul className="space-y-2 mb-6">
                    <li>
                      <Link
                        href="/gids/google-my-business-optimalisatie"
                        className="text-cyan-300 hover:text-cyan-400 text-sm transition-colors duration-200"
                      >
                    ...
                    <li>
                      <Link
                        href="/gids/lokale-zoekwoorden-onderzoek"
                        className="text-cyan-300 hover:text-cyan-400 text-sm transition-colors duration-200"
                      >
                    ...
                    <li>
                      <Link
                        href="/gids/regionale-content-marketing"
                        className="text-cyan-300 hover:text-cyan-400 text-sm transition-colors duration-200"
                      >
...
export function ContentClusterNavigation({
  ...
  const getRelatedContent = () => {
      ...
      (cluster) =>
        cluster.supportingTopics.some(
          (topic) =>
            ...
            cluster.mainTopic.toLowerCase().replace(/\s+/g, "-") ===
              currentSlug,
    ...
    const relatedTopics = currentCluster.supportingTopics
      .filter(
        (topic) => topic.toLowerCase().replace(/\s+/g, "-") !== currentSlug,
      )
      .slice(0, 3);

    const clusterLinks = currentCluster.internalLinks.filter(
      (link) => !link.includes(currentSlug || ""),
    );
  ...
  return (
    ...
    >
      <div className="bg-cosmic-800/20 p-8 rounded-2xl border border-cosmic-700/40">
        <SemanticHeading
          level={3}
          className="text-xl font-bold mb-6 text-cyan-300"
        >
          Meer over {mainTopic}
        </SemanticHeading>
