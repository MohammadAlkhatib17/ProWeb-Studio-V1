...
export const DynamicHexagonalPrism = lazy(
  () => import("../three/HexagonalPrism"),
);

export const DynamicTechPlaygroundScene = lazy(
        ...
        <Component
          ...
          ref={(ref: unknown) => {
            if (ref) {
              ...
              console.log(
                `3D Component ${componentName} render time: ${renderTime}ms`,
              );

              // Send to analytics if needed
              if (renderTime > 100) {
                console.warn(
                  `Slow 3D component render: ${componentName} took ${renderTime}ms`,
                );
              }
            }
          }}
