    ...
    >
      ...
      {topLeft && (
        <div className="absolute left-3 top-3 sm:left-4 sm:top-4">
          <div
            className="inline-flex items-center gap-2 rounded-full bg-white/7 backdrop-blur-md ring-1 ring-white/15 px-2.5 py-1
      ...
      {(bottomLeft || bottomRight) && (
        <div className="absolute inset-x-3 bottom-3 sm:inset-x-4 sm:bottom-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
            ...
            {bottomLeft && (
              <div
                className="min-w-0 rounded-xl bg-white/6 backdrop-blur-md ring-1 ring-white/10 px-3 py-2
